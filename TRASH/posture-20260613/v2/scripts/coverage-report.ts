...
<html>
<head>
    <title>Hive-Flow Coverage Report</title>
    <style>
...
<body>
    <div class="header">
        <h1>📊 Hive-Flow Coverage Report</h1>
    ...
    <div class="footer">
        <p>Hive-Flow Coverage Report - Advanced AI Agent Orchestration System</p>
    </div>
</body>
</html>`;
  ...
  private async generateTextReport(report: CoverageReport): Promise<void> {
    ...
    lines.push("📊 HIVE-FLOW COVERAGE REPORT");
...
async function main(): Promise<void> {
  ...
  if (args.help) {
    console.log(`
📊 Hive-Flow Coverage Analysis Tool
