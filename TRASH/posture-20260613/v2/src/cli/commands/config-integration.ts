...
function showConfigIntegrationHelp() {
  ...
  console.log('Usage:');
  console.log('  hive-flow config-integration <command> [options]\\n');
  ...
  console.log('  hive-flow config-integration setup --enable-ruv-swarm');
  console.log('  hive-flow config-integration preset development');
  console.log('  hive-flow config-integration sync --force');
  console.log('  hive-flow config-integration export my-config.json');
  console.log('  hive-flow config-integration status --verbose');
}
...
async function handleExport(ctx: CommandContext) {
  ...
  try {
    ...
    if (format === 'yaml') {
      ...
      const yamlContent = `# Hive-Flow Configuration Export
