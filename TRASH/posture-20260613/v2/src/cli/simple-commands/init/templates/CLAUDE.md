...
- `npx hive-flow sparc batch <modes> "<task>"`: Execute multiple SPARC modes in parallel
- `npx hive-flow sparc pipeline "<task>"`: Execute full SPARC pipeline with parallel processing
- `npx hive-flow sparc concurrent <mode> "<tasks-file>"`: Process multiple tasks concurrently
...
npx hive-flow sparc run spec-pseudocode "Define user authentication requirements" --parallel
```
...
npx hive-flow sparc run spec-pseudocode "Create authentication flow pseudocode" --batch-optimize
```
...
npx hive-flow sparc run architect "Design authentication service architecture" --parallel
```
...
npx hive-flow sparc tdd "implement user authentication system" --batch-tdd
```
...
npx hive-flow sparc run integration "integrate authentication with user management" --parallel
```
...
1. **MCP**: `mcp__hive-flow__swarm_init` (coordination setup)
2. **MCP**: `mcp__hive-flow__agent_spawn` (planning agents)
3. **MCP**: `mcp__hive-flow__task_orchestrate` (task coordination)
...
7. **MCP**: `mcp__hive-flow__memory_usage` (store results)

**❌ WRONG Workflow:**

1. **MCP**: `mcp__hive-flow__terminal_execute` (DON'T DO THIS)
...
[Single Message with BatchTool]:
  ...
  mcp__hive-flow__agent_spawn { type: "code-analyzer" }
  mcp__hive-flow__agent_spawn { type: "tester" }
  mcp__hive-flow__agent_spawn { type: "task-orchestrator" }
...
- Use the `mcp__hive-flow__swarm_init` tool to set up coordination topology
- Choose: mesh, hierarchical, ring, or star
- This creates a coordination framework for Claude Code's work

**Spawn agents:**

- Use `mcp__hive-flow__agent_spawn` tool to create specialized coordinators
- Agent types represent different thinking patterns, not actual coders
- They help Claude Code approach problems from different angles

**Orchestrate tasks:**

- Use `mcp__hive-flow__task_orchestrate` tool to coordinate complex workflows
...
- `mcp__hive-flow__swarm_init` - Set up coordination topology for Claude Code
- `mcp__hive-flow__agent_spawn` - Create cognitive patterns to guide Claude Code
- `mcp__hive-flow__task_orchestrate` - Break down and coordinate complex tasks

### Monitoring Tools:

- `mcp__hive-flow__swarm_status` - Monitor coordination effectiveness
- `mcp__hive-flow__agent_list` - View active cognitive patterns
- `mcp__hive-flow__agent_metrics` - Track coordination performance
- `mcp__hive-flow__task_status` - Check workflow progress
- `mcp__hive-flow__task_results` - Review coordination outcomes

### Memory & Neural Tools:

- `mcp__hive-flow__memory_usage` - Persistent memory across sessions
- `mcp__hive-flow__neural_status` - Neural pattern effectiveness
- `mcp__hive-flow__neural_train` - Improve coordination patterns
- `mcp__hive-flow__neural_patterns` - Analyze thinking approaches

### GitHub Integration Tools (NEW!):

- `mcp__hive-flow__github_swarm` - Create specialized GitHub management swarms
- `mcp__hive-flow__repo_analyze` - Deep repository analysis with AI
- `mcp__hive-flow__pr_enhance` - AI-powered pull request improvements
- `mcp__hive-flow__issue_triage` - Intelligent issue classification
- `mcp__hive-flow__code_review` - Automated code review with swarms

### System Tools:

- `mcp__hive-flow__benchmark_run` - Measure coordination efficiency
- `mcp__hive-flow__features_detect` - Available capabilities
- `mcp__hive-flow__swarm_monitor` - Real-time coordination tracking
...
- Tool: `mcp__hive-flow__swarm_init`
- Parameters: `{"topology": "mesh", "maxAgents": 5, "strategy": "balanced"}`
- Result: Creates a mesh topology for comprehensive exploration

**Step 2:** Define research perspectives

- Tool: `mcp__hive-flow__agent_spawn`
...
- Tool: `mcp__hive-flow__task_orchestrate`
...
- Tool: `mcp__hive-flow__github_swarm`
...
4. **ALL AGENTS MUST USE COORDINATION TOOLS** - Every spawned agent MUST use hive-flow hooks and memory
...
Message 1: [BatchTool]
  ...
  - mcp__hive-flow__agent_spawn (researcher)
  - mcp__hive-flow__agent_spawn (coder)
  - mcp__hive-flow__agent_spawn (code-analyzer)
  - mcp__hive-flow__agent_spawn (tester)
  - mcp__hive-flow__agent_spawn (task-orchestrator)
...
[BatchTool]:
  ...
  - mcp__hive-flow__agent_spawn { type: "system-architect", name: "System Designer" }
  - mcp__hive-flow__agent_spawn { type: "coder", name: "API Developer" }
  - mcp__hive-flow__agent_spawn { type: "coder", name: "Frontend Dev" }
  - mcp__hive-flow__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  - mcp__hive-flow__agent_spawn { type: "tester", name: "QA Engineer" }
  - mcp__hive-flow__agent_spawn { type: "researcher", name: "Tech Lead" }
  - mcp__hive-flow__agent_spawn { type: "task-orchestrator", name: "PM" }
  - TodoWrite { todos: [multiple todos at once] }

STEP 2: PARALLEL TASK EXECUTION (Single Message!)
[BatchTool]:
  - mcp__hive-flow__task_orchestrate { task: "main task", strategy: "parallel" }
  - mcp__hive-flow__memory_usage { action: "store", key: "init", value: {...} }
...
[BatchTool - Message 1]:
  ...
  mcp__hive-flow__swarm_init { topology: "hierarchical", maxAgents: 8, strategy: "parallel" }
  mcp__hive-flow__agent_spawn { type: "system-architect", name: "System Designer" }
  mcp__hive-flow__agent_spawn { type: "coder", name: "API Developer" }
  mcp__hive-flow__agent_spawn { type: "coder", name: "Auth Expert" }
  mcp__hive-flow__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  mcp__hive-flow__agent_spawn { type: "tester", name: "Test Engineer" }
  mcp__hive-flow__agent_spawn { type: "task-orchestrator", name: "Lead" }
  ...
  // Start orchestration
  mcp__hive-flow__task_orchestrate { task: "Build REST API", strategy: "parallel" }

  // Store initial memory
  mcp__hive-flow__memory_usage { action: "store", key: "project/init", value: { started: Date.now() } }
...
Message 1: mcp__hive-flow__swarm_init
Message 2: mcp__hive-flow__agent_spawn (just one agent)
Message 3: mcp__hive-flow__agent_spawn (another agent)
Message 4: TodoWrite (single todo)
...
4. **Monitor Progress**: Use mcp**hive-flow**swarm_monitor for real-time tracking
...
- Examples: https://github.com/ruvnet/hive-flow/tree/main/examples

---

Remember: **Hive Flow coordinates, Claude Code creates!** Start with `mcp__hive-flow__swarm_init` to enhance your development workflow.
