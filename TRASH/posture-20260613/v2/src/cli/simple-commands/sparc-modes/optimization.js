...
1. **Performance Analysis** (15 mins)
   ...
   - Store analysis: \`npx hive-flow memory store ${memoryNamespace}_performance_analysis "..."\`
...
2. **Refactoring Plan** (10 mins)
   ...
   - Identify quick wins
   - Estimate impact
   - Store plan: \`npx hive-flow memory store ${memoryNamespace}_refactor_plan "..."\`
...
3. **Code Optimization** (25 mins)
   ...
   - Store changes: \`npx hive-flow memory store ${memoryNamespace}_optimizations "..."\`
