...
export async function migrateHooksCommand(flags, args) {
  console.log('🔄 Hive Flow Hooks Migration\n');
...
export const migrateHooksCommandConfig = {
  ...
  examples: [
    'hive-flow migrate-hooks                    # Migrate all found settings.json files',
    'hive-flow migrate-hooks .claude/settings.json  # Migrate specific file',
  ],
  details: `
