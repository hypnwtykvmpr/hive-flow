  ...
  return errorRecovery.retryWithRecovery(
    async () => {
      try {
        ...
        printSuccess('Initializing Hive-Flow project...');
        ...
        console.log('\n   Next steps:');
        console.log('   1. Run "hive-flow swarm --help" to see swarm options');
        ...
        console.log('   4. Run "hive-flow help" for all available commands');

        if (options.sparc) {
          console.log('   5. Run "hive-flow sparc modes" to see available SPARC modes');
