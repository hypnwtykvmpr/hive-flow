...
1. Run directly: `npx hive-flow sparc run refinement-optimization-mode-optimized "your task"`
...
npx hive-flow sparc run refinement-optimization-mode-optimized "optimize all modules"

# Batch refactor large files
npx hive-flow sparc run refinement-optimization-mode-optimized "break down all files over 500 lines"
```
