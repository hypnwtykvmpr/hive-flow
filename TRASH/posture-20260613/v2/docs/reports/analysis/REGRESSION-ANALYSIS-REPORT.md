...
#### 3.2 Agent Run
**Command**: `hive-flow agent run coder "test task" --dry-run`
...
#### 4.1 Booster Help
**Command**: `hive-flow agent booster help`
...
#### 4.2 Booster Edit
**Command**: `hive-flow agent booster edit tests/benchmark/test.js "Add JSDoc comments" --dry-run`
...
**Command**: `hive-flow agent booster benchmark --iterations 5`
...
- CLI Access: `hive-flow agent booster <command>`
...
# Core commands
hive-flow agent list                                    # ✅ Working
hive-flow agent run coder "test task" --dry-run        # ✅ Working
hive-flow hooks --help                                  # ✅ Working
hive-flow memory list                                   # ✅ Working

# Agent Booster
hive-flow agent booster help                            # ✅ Working (58 lines)
hive-flow agent booster edit <file> --dry-run          # ✅ 0ms
hive-flow agent booster benchmark --iterations 5        # ✅ 352x validated

# Help text
hive-flow --help                                        # ✅ Working
hive-flow agent --help                                  # ✅ Agent Booster visible
```
