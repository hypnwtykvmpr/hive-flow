...
- ❌ **Line 133**: `./bin/hive-flow --version` - Binary exists at this path
...
- **CI/CD**: Uses `./bin/hive-flow` (correct)
...
- CI/CD Pipeline: https://github.com/ruvnet/hive-flow/actions/runs/19621632521
- Rollback Manager: https://github.com/ruvnet/hive-flow/actions/runs/19622456012
- Integration Tests: https://github.com/ruvnet/hive-flow/actions/runs/19622447176
