# hive-flow v2.7.26 - Final Release Summary
...
- `hive-flow@2.7.26` - Production-ready with clean UX
...
npx hive-flow@alpha memory export output.json     # ✅
npx hive-flow@alpha memory import data.json       # ✅
```
...
**Debugging:**
- Enable verbose logging: `DEBUG=* npx hive-flow@alpha`
- Check database: `sqlite3 .swarm/memory.db`
- Verify embeddings: Check console logs
- Monitor npm: `npm view hive-flow`
