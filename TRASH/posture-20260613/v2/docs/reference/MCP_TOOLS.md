...
This document provides a comprehensive reference for all 112 MCP (Model Context Protocol) tools available in the Hive Flow ecosystem.

## Overview

Hive Flow integrates with two MCP tool providers:
- **hive-flow tools**: 87 tools for core functionality
...
## Hive Flow Tools (87 tools)

The hive-flow tools are organized into 8 categories providing comprehensive development, coordination, and system management capabilities.
...
#### `mcp__hive-flow__coordination_sync`
...
#### `mcp__hive-flow__neural_patterns`
...
#### `mcp__hive-flow__neural_predict`
...
#### `mcp__hive-flow__pattern_recognize`
...
#### `mcp__hive-flow__cognitive_analyze`
...
#### `mcp__hive-flow__learning_adapt`
...
#### `mcp__hive-flow__neural_compress`
...
#### `mcp__hive-flow__ensemble_create`
...
#### `mcp__hive-flow__transfer_learn`
...
#### `mcp__hive-flow__neural_explain`
...
#### `mcp__hive-flow__memory_namespace`
...
#### `mcp__hive-flow__memory_restore`
...
#### `mcp__hive-flow__memory_compress`
...
#### `mcp__hive-flow__state_snapshot`
...
#### `mcp__hive-flow__context_restore`
...
#### `mcp__hive-flow__memory_analytics`
...
#### `mcp__hive-flow__metrics_collect`
...
#### `mcp__hive-flow__quality_assess`
...
#### `mcp__hive-flow__error_analysis`
...
#### `mcp__hive-flow__workflow_export`
...
#### `mcp__hive-flow__automation_setup`
...
#### `mcp__hive-flow__pipeline_create`
...
#### `mcp__hive-flow__scheduler_manage`
...
#### `mcp__hive-flow__workflow_template`
...
#### `mcp__hive-flow__parallel_execute`
...
#### `mcp__hive-flow__github_repo_analyze`
...
#### `mcp__hive-flow__github_pr_manage`
...
#### `mcp__hive-flow__github_issue_track`
...
#### `mcp__hive-flow__github_release_coord`
...
#### `mcp__hive-flow__github_workflow_auto`
...
#### `mcp__hive-flow__github_code_review`
...
#### `mcp__hive-flow__github_sync_coord`
...
#### `mcp__hive-flow__github_metrics`
...
#### `mcp__hive-flow__daa_agent_create`
...
#### `mcp__hive-flow__daa_capability_match`
...
#### `mcp__hive-flow__daa_resource_alloc`
...
#### `mcp__hive-flow__daa_lifecycle_manage`
...
#### `mcp__hive-flow__daa_communication`
...
#### `mcp__hive-flow__daa_fault_tolerance`
...
#### `mcp__hive-flow__features_detect`
...
#### `mcp__hive-flow__restore_system`
...
#### `mcp__hive-flow__diagnostic_run`
...
Many hive-flow tools support batch operations for efficiency:

```json
{
  "tool": "mcp__hive-flow__parallel_execute",
  "params": {
    "operations": [
...
```json
[
  {"tool": "mcp__hive-flow__swarm_init", "params": {"topology": "hierarchical"}},
  {"tool": "mcp__hive-flow__agent_spawn", "params": {"type": "coordinator"}},
...
- Use `mcp__hive-flow__parallel_execute` for concurrent operations
...
```json
{
  "workflow": [
    ...
    {
      "tool": "mcp__hive-flow__performance_report",
