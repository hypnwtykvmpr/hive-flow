...
.hive-flow/metrics/system-metrics.json
.hive-flow/metrics/task-metrics.json
.claude/checkpoints/task-1754446387.json
benchmark/.hive-flow/metrics/performance.json
benchmark/.hive-flow/metrics/system-metrics.json
benchmark/.hive-flow/metrics/task-metrics.json
...
benchmark/archive/old-reports/REAL_HIVE_FLOW_INTEGRATION_REPORT.md
...
benchmark/examples/.hive-flow/metrics/agent-metrics.json
benchmark/examples/.hive-flow/metrics/performance.json
benchmark/examples/.hive-flow/metrics/task-metrics.json
...
benchmark/src/swarm_benchmark/core/__pycache__/hive_flow_real_executor.cpython-312.pyc
...
benchmark/src/swarm_benchmark/core/hive_flow_real_executor.py
...
benchmark/test_real_hive_flow.py
benchmark/test_real_execution.py
benchmark/test_real_metrics.py
benchmark/test_real_simple.py
benchmark/test_simple_run.py
benchmark/tests/.hive-flow/metrics/performance.json
benchmark/tests/.hive-flow/metrics/task-metrics.json
...
benchmark/tests/integration/__pycache__/test_real_hive_flow_integration.cpython-312-pytest-8.4.0.pyc
...
benchmark/tests/integration/test_real_hive_flow.py
benchmark/tests/integration/test_real_hive_flow_integration.py
