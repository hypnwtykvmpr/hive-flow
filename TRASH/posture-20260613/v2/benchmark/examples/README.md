# Hive Flow Benchmark Examples

This directory contains organized examples for using the Hive Flow benchmark suite with different strategies, coordination modes, and real-world scenarios.
...
├── real/                   # Real hive-flow execution examples
...
**Production-ready benchmarks with actual hive-flow execution:**
...
1. **Command not found**: Ensure `hive-flow@alpha` is installed globally
