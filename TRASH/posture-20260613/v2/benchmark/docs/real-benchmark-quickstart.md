# Real Hive-Flow Benchmark Quick Start Guide

## Overview

The Real Benchmark Engine executes actual `hive-flow` commands and captures comprehensive performance metrics, resource usage, and quality assessments. This guide helps you get started quickly.

## Installation

1. Ensure `hive-flow` is installed and accessible:
```bash
which hive-flow
# or
hive-flow --version
...
### Issue: hive-flow not found
```bash
# Check installation
which hive-flow

# Add to PATH if needed
export PATH="$PATH:/path/to/hive-flow"
```
