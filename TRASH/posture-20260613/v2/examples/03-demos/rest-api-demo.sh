#!/bin/bash
# Demonstrate what the Hive Flow Swarm creates for a REST API

echo "🐝 Hive Flow Swarm - REST API Creation Demo"
echo "==========================================="
echo ""
echo "This demonstrates what the swarm system creates when you run:"
echo "./bin/hive-flow swarm \"Build a REST API in examples/\" --strategy development"
echo ""
...
echo "   npm start"
echo ""
echo "This is what the Hive Flow Swarm system creates when you run:"
echo "./bin/hive-flow swarm \"Build a REST API in examples/\" --strategy development"
echo ""