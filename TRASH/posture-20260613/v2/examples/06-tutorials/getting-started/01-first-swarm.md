# Your First Hive Flow Swarm

This tutorial will guide you through creating your first swarm and understanding how Hive Flow works.

## Prerequisites

- Hive Flow installed (`npm install -g hive-flow`)
...
```bash
cd examples
../hive-flow swarm create "Build a hello world CLI application" \
  --name my-first-swarm \
  --output ./output/hello-world
```

### What happens:
1. Hive Flow creates a swarm coordinator
