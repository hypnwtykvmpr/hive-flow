# Hive-Flow Parallel Agent Testing

This example demonstrates how to run multiple Hive-Flow SPARC agents in parallel to test their capabilities and measure performance.
...
This example is part of the Hive-Flow project and follows the same license terms.