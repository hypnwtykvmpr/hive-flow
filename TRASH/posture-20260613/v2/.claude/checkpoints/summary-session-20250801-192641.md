...
CHANGELOG.md
bin/hive-flow.js
hive-flow-2.0.0-alpha.83.tgz
hive-flow-wiki
package-lock.json
src/mcp/mcp-server.js
test-alpha-83/.hive-flow/metrics/agent-metrics.json
test-alpha-83/.hive-flow/metrics/performance.json
test-alpha-83/.hive-flow/metrics/task-metrics.json
...
## Recent Commits
cb3a174 🔖 Checkpoint: Edit /workspaces/claude-code-flow/bin/hive-flow.js
