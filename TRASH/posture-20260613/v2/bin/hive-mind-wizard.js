...
async function runInteractiveWizard() {
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log(chalk.gray('  • View status: hive-flow hive-mind status'));
      console.log(chalk.gray('  • Monitor progress: hive-flow hive-mind metrics'));
      console.log(chalk.gray('  • Create another swarm: hive-flow hive-mind wizard'));
      console.log(chalk.gray('  • Learn more: hive-flow help hive-mind\n'));
    ...
    console.log(chalk.gray('You can try manual setup with: hive-flow hive-mind init'));
  }
}
