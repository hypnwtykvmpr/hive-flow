...
async function setupTelemetry() {
  ...
  console.log(`   2. Example: ./hive-flow swarm "analyze code" --claude`);
  console.log(`   3. Check usage: ./hive-flow analysis token-usage --breakdown`);
...
EXAMPLES:
  ...
  hive-flow analysis token-usage --enable-telemetry --breakdown
  ...
  CLAUDE_CODE_ENABLE_TELEMETRY=1 hive-flow swarm "task" --claude
...
async function showSimulatedTokenUsage(breakdown, costAnalysis) {
  ...
  console.log(`  ┌────────────────────────────────────────────────────────┐`);
  console.log(`  │ ./hive-flow analysis setup-telemetry                │`);
  console.log(`  └────────────────────────────────────────────────────────┘`);
  ...
  console.log(`  ┌────────────────────────────────────────────────────────┐`);
  console.log(`  │ ./hive-flow analysis token-usage --enable-telemetry │`);
  console.log(`  └────────────────────────────────────────────────────────┘`);
  
  console.log(`\n✅ AFTER SETUP:`);
  console.log(`  1. Run Claude commands: ./hive-flow swarm "task" --claude`);
  ...
  console.log(`  • View raw data: cat .hive-flow/metrics/token-usage.json`);
  console.log(`  • Reset tracking: rm -rf .hive-flow/metrics/token-usage.json`);
}
