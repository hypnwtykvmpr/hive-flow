...
```bash
hive-flow pair --switch <session-id>
```

### Merge Sessions
```bash
hive-flow pair --merge <session-1> <session-2>
```
...
### Manual Recovery
```bash
hive-flow pair --recover [--point <timestamp>]
```

### Crash Recovery
```bash
hive-flow pair --crash-recovery
```
...
### Share with Team
```bash
hive-flow pair --share <session-id> \
  --team <team-id>
```

### Export for Review
```bash
hive-flow pair --export-review <session-id>
```

### Create Learning Material
```bash
hive-flow pair --create-tutorial <session-id>
```
