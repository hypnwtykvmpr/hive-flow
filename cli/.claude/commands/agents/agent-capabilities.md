...
Matrix of agent capabilities and their specializations for Hive Flow V3.
...
### Swarm Tools
```
hierarchical-coordinator: mcp__hive-flow__swarm_*, mcp__hive-flow__agent_*
mesh-coordinator: mcp__hive-flow__swarm_*, mcp__hive-flow__coordination_*
adaptive-coordinator: mcp__hive-flow__topology_*, mcp__hive-flow__swarm_*
```

### GitHub Tools
```
pr-manager: mcp__github__*, Bash (gh CLI)
code-review-swarm: mcp__github__*, mcp__hive-flow__swarm_*
release-manager: mcp__github__*, mcp__hive-flow__workflow_*
```
