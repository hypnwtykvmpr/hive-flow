...
1. **Model Cache**: Enable with `HIVE_FLOW_MODEL_CACHE_MB=512`
2. **Parallel Workers**: Enable with `HIVE_FLOW_WORKER_PARALLEL=true`
3. **Warning Suppression**: Enable with `HIVE_FLOW_SUPPRESS_WARNINGS=true`
