...
build_wasm_module "gastown-gnn-wasm"
...
gnn_wasm="$WASM_DIR/gastown-gnn-wasm/pkg/gastown_gnn_wasm_bg.wasm"
...
printf "%-30s %10s %10s\n" "gastown-gnn-wasm" "$(format_size $gnn_size)" "$(format_size $gnn_gz_size)"
printf "%-30s %10s %10s\n" "------------------------------" "----------" "----------"
...
echo "  - $WASM_DIR/gastown-gnn-wasm/pkg/"
echo ""
