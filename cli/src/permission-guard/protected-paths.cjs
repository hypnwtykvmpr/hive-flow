...
const DEFAULT_POLICY = {
  protectedWrite: [
    ...
    '.hive-flow/terminals/',
    '.hive-flow/workflows/',
    'cli/src/permission-guard/',
    'cli/dist/src/permission-guard/',
    'cli/dist/src/mcp-tools/',
...
function policyCandidates() {
  return [
    ...
    path.resolve(process.cwd(), 'cli', 'src', 'permission-guard', 'protected-paths.policy.json'),
  ];
}
