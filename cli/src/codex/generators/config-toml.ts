/**
 * @hive-flow/cli/codex - config.toml Generator
 *
...
export async function generateConfigToml(options: ExtendedConfigTomlOptions = {}): Promise<string> {
  ...
  // Header
  lines.push('# =============================================================================');
  lines.push('# Hive Flow V3 - Codex Configuration');
  lines.push('# =============================================================================');
  lines.push('# Generated by: @hive-flow/cli/codex');
  lines.push('# Documentation: ');
  lines.push('# ');
  lines.push('# This file configures the Codex CLI for Hive Flow integration.');
  ...
  lines.push(`# Default: ${CODEX_CLI_DEFAULT_MODEL}; custom provider-supported model IDs are also accepted`);
  ...
  // MCP Servers
  if (mcpServers.length > 0 || true) { // Always include hive-flow by default
    lines.push('# =============================================================================');
    ...
    const hasHiveFlow = mcpServers.some(s => s.name === 'hive-flow');
    if (!hasHiveFlow) {
  ...
  if (logging.filePath || logging.destination === 'file' || logging.destination === 'both') {
    ...
    lines.push(`file_path = "${logging.filePath ?? './logs/hive-flow.log'}"`);
    lines.push('');
...
export async function generateMinimalConfigToml(options: ConfigTomlOptions = {}): Promise<string> {
  ...
  return `# Hive Flow V3 - Minimal Codex Configuration
...
export async function generateCIConfigToml(): Promise<string> {
  return `# =============================================================================
# Hive Flow V3 - CI/CD Pipeline Configuration
# =============================================================================
...
export async function generateEnterpriseConfigToml(): Promise<string> {
  return `# =============================================================================
# Hive Flow V3 - Enterprise Configuration
# =============================================================================
...
export async function generateDevConfigToml(): Promise<string> {
  return `# =============================================================================
# Hive Flow V3 - Development Configuration
# =============================================================================
...
export async function generateSecureConfigToml(): Promise<string> {
  return `# =============================================================================
# Hive Flow V3 - Security-Focused Configuration
# =============================================================================
