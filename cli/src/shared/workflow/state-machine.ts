 ...
 * Intentionally self-contained — @hive-flow/cli/shared does not depend on
...
const FORWARD_TRANSITIONS: Record<WorkflowStateName, WorkflowStateName[]> = {
  ...
  VERIFYING_IMPLEMENTATION: ['TESTING', 'AUDITING', 'IMPLEMENTING'],
  TESTING: ['VERIFYING_TESTING'],
  DEBUGGING: ['VERIFYING_DEBUGGING'],
  VERIFYING_TESTING: ['DEBUGGING', 'AUDITING', 'TESTING', 'IMPLEMENTING'],
  VERIFYING_DEBUGGING: ['AUDITING', 'DEBUGGING', 'TESTING', 'IMPLEMENTING'],
  AUDITING: ['VERIFYING_AUDIT'],
  VERIFYING_AUDIT: ['COMMITTING', 'IMPLEMENTING', 'TESTING'],
  COMMITTING: ['COMPLETE'],
  COMPLETE: [],
};
