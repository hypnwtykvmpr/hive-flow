...
export const issuesCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow issues list', description: 'List all claims' },
    { command: 'hive-flow issues claim 123 --agent coder:coder-1', description: 'Claim as agent' },
    { command: 'hive-flow issues handoff 123 --to agent:tester:tester-1', description: 'Handoff to tester' },
    { command: 'hive-flow issues stealable', description: 'List stealable' },
    { command: 'hive-flow issues steal 123 --agent coder:coder-2', description: 'Steal issue' },
    { command: 'hive-flow issues board', description: 'Visual board' },
  ],
