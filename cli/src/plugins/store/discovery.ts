...
export const DEFAULT_PLUGIN_STORE_CONFIG: PluginStoreConfig = {
  ...
  defaultRegistry: 'hive-flow-official',
  gateway: 'https://gateway.pinata.cloud',
  timeout: 30000,
  cacheDir: '.hive-flow/plugins/cache',
...
export class PluginDiscoveryService {
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      ...
      },
      {
        ...
        description: 'Analytics and metrics visualization for Hive Flow operations',
        version: '1.2.0',
      ...
      {
        id: '@hive-flow/plugin-agentic-qe',
        name: '@hive-flow/plugin-agentic-qe',
      ...
      {
        id: '@hive-flow/plugin-prime-radiant',
        name: '@hive-flow/plugin-prime-radiant',
      ...
      {
        id: '@hive-flow/plugin-healthcare-clinical',
        name: '@hive-flow/plugin-healthcare-clinical',
      ...
      {
        id: '@hive-flow/plugin-financial-risk',
        name: '@hive-flow/plugin-financial-risk',
      ...
      {
        id: '@hive-flow/plugin-legal-contracts',
      ...
      {
        id: '@hive-flow/plugin-code-intelligence',
        name: '@hive-flow/plugin-code-intelligence',
      ...
      {
        id: '@hive-flow/plugin-test-intelligence',
        name: '@hive-flow/plugin-test-intelligence',
      ...
      {
        id: '@hive-flow/plugin-perf-optimizer',
      ...
      {
        id: '@hive-flow/plugin-neural-coordination',
        name: '@hive-flow/plugin-neural-coordination',
      ...
      {
        id: '@hive-flow/plugin-cognitive-kernel',
      ...
      {
        id: '@hive-flow/plugin-quantum-optimizer',
        name: '@hive-flow/plugin-quantum-optimizer',
      ...
      {
        id: '@hive-flow/plugin-hyperbolic-reasoning',
        name: '@hive-flow/plugin-hyperbolic-reasoning',
      ...
      // Gas Town Bridge - Multi-agent orchestrator integration
      {
        ...
        description: 'Legacy external Gas Town bridge with WASM-accelerated formula parsing, optional compatibility sync, convoy management, and graph analysis.',
        version: '0.1.0',
        ...
        tags: ['gastown', 'orchestration', 'legacy-compatibility', 'formulas', 'wasm', 'convoy', 'workflows'],
        keywords: ['gastown', 'orchestration', 'legacy-compatibility'],
        downloads: 0,
        rating: 0,
        ratingCount: 0,
        lastUpdated: baseTime,
        ...
        commands: ['gastown sync', 'gastown convoy', 'gastown formula'],
        permissions: ['filesystem', 'memory', 'network'],
        exports: ['ConvoyManager', 'FormulaEngine', 'GastownSync'],
        verified: true,
        trustLevel: 'official',
        securityAudit: {
          auditor: 'hive-flow-security-team',
      ...
      {
        id: '@hive-flow/teammate-plugin',
        name: '@hive-flow/teammate-plugin',
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      ...
      '@hive-flow/plugin-financial-risk',
