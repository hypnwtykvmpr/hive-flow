 ...
 *
 * @module @hive-flow/cli/guidance/adversarial
 * @category Security
 * @since 3.0.0-alpha.1
 *
 * @example
 * ```typescript
 * import { createThreatDetector, createCollusionDetector, createMemoryQuorum } from '@hive-flow/cli/guidance/adversarial';
 *
 * // Threat detection
