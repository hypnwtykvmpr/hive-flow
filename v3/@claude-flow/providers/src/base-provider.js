...
export class BaseProvider extends EventEmitter {
    ...
    constructor(options) {
        ...
        this.circuitBreaker = new CircuitBreaker(`llm-${this.config.provider}`, options.circuitBreakerOptions?.threshold || 5, options.circuitBreakerOptions?.resetTimeout || 60000);
    }
    /**
