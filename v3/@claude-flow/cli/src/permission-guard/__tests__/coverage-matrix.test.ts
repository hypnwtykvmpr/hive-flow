...
// Mock @claude-flow/shared before any imports
vi.mock('@claude-flow/shared', () => ({
...
describe('Original 25 Attack Vectors — Full Pipeline', () => {
  const original25: Array<{ id: number; name: string; cmd: string }> = [
    ...
    { id: 4, name: 'python3 os.remove', cmd: 'python3 -c "import os; os.remove(\'x\')"' },
    { id: 5, name: 'python3 shutil.rmtree', cmd: 'python3 -c "import shutil; shutil.rmtree(\'x\')"' },
