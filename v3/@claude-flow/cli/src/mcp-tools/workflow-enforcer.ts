...
export type AgentModelTier = 'opus' | 'sonnet' | 'haiku' | 'inherit';
...
const MONOREPO_PACKAGES = [
  '@claude-flow/cli', '@claude-flow/hooks', '@claude-flow/memory',
  '@claude-flow/security', '@claude-flow/guidance', '@claude-flow/shared',
  '@claude-flow/codex', '@claude-flow/providers',
];
