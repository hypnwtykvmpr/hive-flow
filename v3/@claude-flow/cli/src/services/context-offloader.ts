...
export class ContextOffloader {
  ...
  constructor() {
    this.provider = process.env.CLAUDE_FLOW_OFFLOAD_PROVIDER || 'gemini-cli';
    this.fallback = process.env.CLAUDE_FLOW_OFFLOAD_FALLBACK || 'codex-cli';
    this.enabled = process.env.CLAUDE_FLOW_OFFLOAD_ENABLED !== 'false';
  }
