 ...
 *
 * Bridge between GUPP work tracking and Hive Flow session management.
...
/**
 * Session manager interface (Hive Flow compatible)
 */
...
/**
 * GUPP Adapter - Bridge between Gas Town work tracking and Hive Flow sessions
 *
