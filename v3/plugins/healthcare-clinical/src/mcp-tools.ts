...
export const patientSimilarityTool: MCPTool = {
  ...
  description: 'Find similar patient cases based on clinical features for treatment guidance. Uses HNSW vector search for optimized faster similarity matching.',
  category: 'healthcare',
  version: '1.0.0',
