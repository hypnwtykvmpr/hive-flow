 ...
 *
 * Features:
 * - Patient similarity search using HNSW (optimized faster)
 ...
 * @module @hive-flow/plugin-healthcare-clinical
 */
...
export const pluginMetadata = {
  ...
  wasmPackages: [
    'micro-hnsw-wasm',
    'local-clinical-graph-kernel',
    'local-ontology-hierarchy-kernel',
    'local-clinical-sparse-kernel',
  ],
};
