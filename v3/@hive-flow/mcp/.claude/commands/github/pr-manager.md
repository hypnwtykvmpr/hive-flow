...
## Purpose
Comprehensive pull request management with hive-flow coordination for automated reviews, testing, and merge workflows.
...
mcp__hive-flow__agent_spawn { type: "reviewer", name: "Code Quality Reviewer" }
mcp__hive-flow__agent_spawn { type: "tester", name: "Testing Agent" }
mcp__hive-flow__agent_spawn { type: "coordinator", name: "PR Coordinator" }

// Create PR and orchestrate review
mcp__github__create_pull_request {
  owner: "hypnwtykvmpr",
  repo: "hive-flow",
  title: "Integration: claude-code-flow and hive-flow",
  head: "integration/claude-code-flow-hive-flow",
  base: "main",
...
mcp__github__get_pull_request_files { owner: "hypnwtykvmpr", repo: "hive-flow", pull_number: 54 }
...
mcp__github__get_pull_request_status { owner: "hypnwtykvmpr", repo: "hive-flow", pull_number: 54 }
...
mcp__github__merge_pull_request {
  ...
  pull_number: 54,
  merge_method: "squash",
  commit_title: "feat: Complete claude-code-flow and hive-flow integration",
...
[Single Message - Complete PR Management]:
  ...
  mcp__hive-flow__agent_spawn { type: "coordinator", name: "Merge Coordinator" }
