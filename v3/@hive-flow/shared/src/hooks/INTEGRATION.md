...
```typescript
import { createEventBus } from '@hive-flow/shared/core';
import { createHookRegistry, createHookExecutor } from '@hive-flow/shared/hooks';
import { EventStore } from '@hive-flow/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@hive-flow/shared/hooks';
...
import { Plugin } from '@hive-flow/shared';
import { HookEvent, HookPriority } from '@hive-flow/shared/hooks';
...
```typescript
// v3/@hive-flow/shared/src/mcp/tools/hooks.ts
