 ...
 *
 * @module @hive-flow/guidance/generators
 */
...
export function generateClaudeMd(profile: ProjectProfile): string {
  ...
  if (profile.guidanceControlPlane) {
    ...
    sections.push('');
    sections.push('This project uses `@hive-flow/guidance` to enforce these rules programmatically.');
  ...
  if (profile.guidanceControlPlane) {
    skills.push({
      ...
      instructions: [
        ...
        '',
        'This project uses `@hive-flow/guidance` to enforce CLAUDE.md rules programmatically.',
        '',
