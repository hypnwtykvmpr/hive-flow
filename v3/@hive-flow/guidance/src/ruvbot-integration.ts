 ...
 *
 * Bridges ruvbot (npm: ruvbot@0.1.8) with the @hive-flow/guidance control
 ...
 *
 * @module @hive-flow/guidance/ruvbot-integration
 */
...
/**
 * Bridges a ruvbot instance with the @hive-flow/guidance control plane.
 *
