...
[![Performance](https://img.shields.io/badge/Performance-<5ms-brightgreen.svg)](https://github.com/ruvnet/hive-flow)
...
```typescript
import { OpenAIEmbeddingService } from '@hive-flow/embeddings';
...
```typescript
import { TransformersEmbeddingService } from '@hive-flow/embeddings';
...
```typescript
import { MockEmbeddingService } from '@hive-flow/embeddings';
...
```typescript
import { chunkText, estimateTokens, reconstructFromChunks } from '@hive-flow/embeddings';
...
```typescript
import { PersistentEmbeddingCache, isPersistentCacheAvailable } from '@hive-flow/embeddings';
...
# Neural operations
hive-flow embeddings neural drift --baseline "context" --input "check this"
