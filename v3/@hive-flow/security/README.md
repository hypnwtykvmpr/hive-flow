...
[![npm version](https://img.shields.io/npm/v/@hive-flow/security.svg)](https://www.npmjs.com/package/@hive-flow/security)
[![npm downloads](https://img.shields.io/npm/dm/@hive-flow/security.svg)](https://www.npmjs.com/package/@hive-flow/security)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Security Audit](https://img.shields.io/badge/Security-Audited-green.svg)](https://github.com/hypnwtykvmpr/hive-flow)
...
```bash
npm install @hive-flow/security
```
...
- [@hive-flow/swarm](../swarm) - Swarm coordination (secure agent spawning)
