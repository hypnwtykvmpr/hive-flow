...
const TEST_PROJECT_ROOT = path.join(os.tmpdir(), 'hive-flow-test-' + Date.now());
...
describe('Statusline Integration', () => {
  ...
  it('should export statusline to file', async () => {
    ...
    const statuslinePath = path.join(TEST_PROJECT_ROOT, '.hive-flow', 'metrics', 'statusline.json');
...
describe('Persistence', () => {
  ...
  it('should save state to disk', async () => {
    ...
    const statePath = path.join(TEST_PROJECT_ROOT, '.hive-flow', 'metrics', 'workers-state.json');
