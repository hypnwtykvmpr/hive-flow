...
[![npm version](https://img.shields.io/npm/v/@hive-flow/swarm.svg)](https://www.npmjs.com/package/@hive-flow/swarm)
[![npm downloads](https://img.shields.io/npm/dm/@hive-flow/swarm.svg)](https://www.npmjs.com/package/@hive-flow/swarm)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![ADR-003](https://img.shields.io/badge/ADR--003-Compliant-green.svg)](https://github.com/hypnwtykvmpr/hive-flow)
[![Agents](https://img.shields.io/badge/Agents-Up%20to%20100+-orange.svg)](https://github.com/hypnwtykvmpr/hive-flow)
...
```typescript
import { createSwarmHub } from '@hive-flow/swarm';
...
```typescript
import { createQueenCoordinator } from '@hive-flow/swarm';
...
```typescript
import { createAttentionCoordinator } from '@hive-flow/swarm';

const attention = createAttentionCoordinator({
  topology: coordinator.getTopology(),
});

// Flash Attention - Flash Attention optimization for long sequences
...
```typescript
import { createFederationHub, getDefaultFederationHub } from '@hive-flow/swarm';
