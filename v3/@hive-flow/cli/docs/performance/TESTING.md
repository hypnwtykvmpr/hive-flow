...
Comprehensive test coverage for the `@hive-flow/cli/performance` module, focusing on Flash Attention optimization and benchmark validation.
...
- **Local attention kernels**: Flash Attention-compatible implementation
