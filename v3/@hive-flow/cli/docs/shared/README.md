...
import { ... } from '@hive-flow/cli/shared';

// Submodule exports (for tree-shaking or specific imports)
import { ... } from '@hive-flow/cli/shared/types';      // Type definitions
import { ... } from '@hive-flow/cli/shared/core';       // Config, interfaces, orchestrator
import { ... } from '@hive-flow/cli/shared/events';     // Event sourcing (ADR-007)
import { ... } from '@hive-flow/cli/shared/hooks';      // Hooks system
import { ... } from '@hive-flow/cli/shared/mcp';        // MCP server infrastructure
import { ... } from '@hive-flow/cli/shared/security';   // Security utilities
import { ... } from '@hive-flow/cli/shared/resilience'; // Retry, circuit breaker, rate limiter
```
...
import type {
  ...
  MCPRequest,
  MCPResponse
} from '@hive-flow/cli/shared/types';
```
...
import type {
  ...
  ICoordinator,
  IEventHandler
} from '@hive-flow/cli/shared/core';
...
```typescript
import { EventBus, EventCoordinator } from '@hive-flow/cli/shared/events';
...
```typescript
import { HooksManager, Hook } from '@hive-flow/cli/shared/hooks';
...
```typescript
import { HealthMonitor, HealthCheck } from '@hive-flow/cli/shared/core';
...
- [@hive-flow/cli/security](../security/README.md) - Security & validation
- [@hive-flow/cli/memory](../cli/docs/memory) - HiveMemory & HNSW indexing
