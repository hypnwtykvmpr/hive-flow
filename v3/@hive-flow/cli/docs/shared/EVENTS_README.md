...
Complete event sourcing implementation for V3 Hive Flow with persistent storage, projections, and event replay.
...
import {
  ...
  AgentStateProjection,
  TaskHistoryProjection
} from '@hive-flow/cli/shared/events';
...
Part of hive-flow V3 - See root LICENSE file.
