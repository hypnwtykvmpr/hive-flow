...
async function main() {
  console.log('');
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  HIVE FLOW V3 - STANDALONE PATTERN STORE TEST              ║');
  ...
  if (failed === 0) {
    ...
    console.log('    npx @hive-flow/cli patterns list');
    console.log('    npx @hive-flow/cli patterns list --featured');
    console.log('    npx @hive-flow/cli patterns search -q "agent"');
    console.log('    npx @hive-flow/cli patterns info -n <pattern-id>');
    console.log('');
  }
