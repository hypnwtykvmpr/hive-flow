 ...
 *
 * @module @hive-flow/cli/guidance/analyzer
 */
...
/** A single benchmark task representing a real Hive Flow scenario */
...
// ── 20 Representative Tasks from Hive Flow History ───────────────────────
...
function getABTasks(): ABTask[] {
  ...
  return [
    ...
    // ── Deployment (2 tasks) ──────────────────────────────────────────
    {
      ...
      prompt: 'Create a multi-stage Dockerfile for the Hive Flow CLI. Include a build stage and a minimal runtime stage. Never include dev dependencies in production.',
      assertions: [
 ...
 *
 * The 20 tasks span 7 task classes drawn from real Hive Flow repo history:
