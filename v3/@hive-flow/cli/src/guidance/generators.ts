 ...
 *
 * @module @hive-flow/cli/guidance/generators
 */
...
export function generateClaudeMd(profile: ProjectProfile): string {
  ...
  if (profile.guidanceControlPlane) {
    ...
    sections.push('');
    sections.push('This project uses `@hive-flow/cli/guidance` to enforce these rules programmatically.');
...
function getDefaultSkills(profile: ProjectProfile): SkillDefinition[] {
  ...
  if (profile.guidanceControlPlane) {
    skills.push({
      ...
      requires: ['@hive-flow/cli/guidance'],
      capabilities: [
      ...
      instructions: [
        ...
        '',
        'This project uses `@hive-flow/cli/guidance` to enforce CLAUDE.md rules programmatically.',
        '',
