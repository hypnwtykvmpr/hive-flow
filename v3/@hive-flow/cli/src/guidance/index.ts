/**
 * @hive-flow/cli/guidance - Guidance Control Plane
 *
 ...
 * - Hivector/HNSW for semantic shard retrieval
 *
 * @module @hive-flow/cli/guidance
 */
...
// available via the '@hive-flow/cli/guidance/hooks' subpath export only.
...
// `import '@hive-flow/cli/guidance'` would throw MODULE_NOT_FOUND for @hive-flow/hooks.
export {
  RunLedger,
  createLedger,
  TestsPassEvaluator,
...
const DEFAULT_CONFIG: GuidanceControlPlaneConfig = {
  ...
  dataDir: './.hive-flow/cli/guidance',
  headlessMode: false,
};
