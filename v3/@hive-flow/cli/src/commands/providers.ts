  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.printTable({
      ...
      data: [
        ...
        { model: 'gpt-5.4', provider: 'Codex CLI', capability: 'Chat', context: '200K', cost: output.success('ChatGPT sub') },
        ...
        { model: 'deepseek-reasoner', provider: 'DeepSeek', capability: 'Chat', context: '64K', cost: '$0.00014/$0.00028' },
