...
const preEditCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'hive-flow hooks pre-edit -f src/api.ts -o refactor', description: 'Pre-edit with operation type' }
  ],
...
const postEditCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks post-edit -f src/utils.ts --success true', description: 'Record successful edit' },
    { command: 'hive-flow hooks post-edit -f src/api.ts --success false -o "Type error"', description: 'Record failed edit' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    // Default file to 'unknown' for backward compatibility (env var may be empty)
    const filePath = ctx.args[0] || ctx.flags.file as string || 'unknown';
...
const postCommandCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks post-command -c "npm test" --success true', description: 'Record successful test run' },
    { command: 'hive-flow hooks post-command -c "npm build" --success false -e 1', description: 'Record failed build' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const command = ctx.args[0] || ctx.flags.command as string;
...
const routeCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'hive-flow hooks route -t "Optimize database queries" -K 5', description: 'Get top 5 suggestions' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const explainCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks explain -t "Fix authentication bug"', description: 'Explain routing decision' },
    { command: 'hive-flow hooks explain -t "Optimize queries" -a coder --verbose', description: 'Verbose explanation for specific agent' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = ctx.args[0] || ctx.flags.task as string;
...
const pretrainCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks pretrain', description: 'Pretrain with embeddings indexing' },
    { command: 'hive-flow hooks pretrain -p ../my-project --depth deep', description: 'Deep analysis of specific project' },
    { command: 'hive-flow hooks pretrain --no-with-embeddings', description: 'Skip embedding indexing' },
    { command: 'hive-flow hooks pretrain --file-types ts,tsx,js', description: 'Index only TypeScript/JS files' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.writeln(output.dim('  Next step: Run "hive-flow hooks build-agents" to generate optimized configs'));
...
const buildAgentsCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks build-agents', description: 'Build all agent configs' },
    { command: 'hive-flow hooks build-agents --focus security -o ./config/agents', description: 'Build security-focused configs' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const metricsCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks metrics', description: 'View 24h metrics' },
    { command: 'hive-flow hooks metrics --period 7d --v3-dashboard', description: 'V3 metrics for 7 days' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferFromProjectCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks transfer from-project -s ../old-project', description: 'Transfer all patterns' },
    { command: 'hive-flow hooks transfer from-project -s ../prod --filter security -m 0.9', description: 'Transfer high-confidence security patterns' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks transfer store list', description: 'List patterns from registry' },
    { command: 'hive-flow hooks transfer store search -q routing', description: 'Search patterns' },
    { command: 'hive-flow hooks transfer store download -p seraphine-genesis', description: 'Download pattern' },
    { command: 'hive-flow hooks transfer store publish', description: 'Publish pattern to registry' },
    { command: 'hive-flow hooks transfer from-project -s ../other-project', description: 'Transfer from project' },
  ],
  action: async (): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln('Run "hive-flow hooks transfer <subcommand> --help" for details');
    return { success: true };
  }
};
...
const preTaskCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks pre-task -i task-123 -d "Fix auth bug"', description: 'Record task start' },
    { command: 'hive-flow hooks pre-task -i task-456 -d "Implement feature" --auto-spawn', description: 'With auto-spawn' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const postTaskCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks post-task -i task-123 --success true', description: 'Record successful completion' },
    { command: 'hive-flow hooks post-task -i task-456 --success false -q 0.3', description: 'Record failed task' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionEndCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks session-end', description: 'End and save session' },
    { command: 'hive-flow hooks session-end --save-state false', description: 'End without saving' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionRestoreCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks session-restore', description: 'Restore latest session' },
    { command: 'hive-flow hooks session-restore -i session-12345', description: 'Restore specific session' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const intelligenceCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks intelligence --status', description: 'Show intelligence status' },
    { command: 'hive-flow hooks intelligence -m real-time', description: 'Enable real-time mode' },
    { command: 'hive-flow hooks intelligence --train', description: 'Force training cycle' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerListCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks worker list', description: 'List all workers' },
    { command: 'hive-flow hooks worker list --active', description: 'Show active instances' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDispatchCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks worker dispatch -t optimize -c src/', description: 'Dispatch optimize worker' },
    { command: 'hive-flow hooks worker dispatch -t audit -p critical', description: 'Security audit with critical priority' },
    { command: 'hive-flow hooks worker dispatch -t testgaps --sync', description: 'Test coverage analysis (sync)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      if (background) {
        output.writeln();
        output.writeln(output.dim(`Check status: hive-flow hooks worker status --id ${result.workerId}`));
      }
...
const workerStatusCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks worker status', description: 'Show running workers' },
    { command: 'hive-flow hooks worker status --id worker_audit_1', description: 'Check specific worker' },
    { command: 'hive-flow hooks worker status --all', description: 'Include completed workers' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDetectCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks worker detect -p "optimize performance"', description: 'Detect triggers in prompt' },
    { command: 'hive-flow hooks worker detect -p "security audit" --auto-dispatch', description: 'Detect and dispatch' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerCancelCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks worker cancel --id worker_audit_1', description: 'Cancel specific worker' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const workerId = ctx.flags['id'] as string;
...
const coverageRouteCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks coverage-route -t "fix bug in auth"', description: 'Route with coverage awareness' },
    { command: 'hive-flow hooks coverage-route -t "add tests" --threshold 90', description: 'Route with custom threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = ctx.args[0] || ctx.flags.task as string;
...
const coverageSuggestCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks coverage-suggest -p src/', description: 'Suggest improvements for src/' },
    { command: 'hive-flow hooks coverage-suggest -p src/services --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const coverageGapsCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks coverage-gaps', description: 'List all coverage gaps' },
    { command: 'hive-flow hooks coverage-gaps --critical-only', description: 'Only critical gaps' },
    { command: 'hive-flow hooks coverage-gaps --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const threshold = ctx.flags.threshold as number || 80;
...
const progressHookCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks progress', description: 'Check current progress' },
    { command: 'hive-flow hooks progress -d', description: 'Detailed breakdown' },
    { command: 'hive-flow hooks progress --sync', description: 'Sync progress to file' },
    { command: 'hive-flow hooks progress --summary', description: 'Human-readable summary' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      if (sync) {
        ...
        output.writeln(output.dim(`  Persisted to .hive-flow/metrics/v3-progress.json`));
...
const workerCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks worker list', description: 'List all workers' },
    { command: 'hive-flow hooks worker dispatch -t optimize', description: 'Dispatch optimizer' },
    { command: 'hive-flow hooks worker detect -p "test coverage"', description: 'Detect from prompt' },
  ],
  action: async (): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Run "hive-flow hooks worker <subcommand> --help" for details');
...
const statuslineCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks statusline', description: 'Display full statusline' },
    { command: 'hive-flow hooks statusline --json', description: 'JSON output for hooks' },
    { command: 'hive-flow hooks statusline --compact', description: 'Single-line status' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    function getSystemMetrics() {
      ...
      const learningJsonPaths = [
        path.join(process.cwd(), '.hive-flow', 'learning.json'),
        path.join(process.cwd(), '.claude', '.hive-flow', 'learning.json'),
      ...
      if (intelligencePct === 0) {
        ...
        if (fs.existsSync(path.join(process.cwd(), '.hive-flow'))) maturityScore += 15;
        if (fs.existsSync(path.join(process.cwd(), 'CLAUDE.md'))) maturityScore += 10;
        if (fs.existsSync(path.join(process.cwd(), 'hive-flow.config.json'))) maturityScore += 10;
    ...
    const dbPaths = [
      path.join(process.cwd(), '.swarm', 'memory.db'),
      path.join(process.cwd(), '.hive-flow', 'memory.db'),
      path.join(process.cwd(), '.claude', 'memory.db'),
      path.join(process.cwd(), 'data', 'memory.db'),
      path.join(process.cwd(), 'memory.db'),
      path.join(process.cwd(), '.agentdb', 'memory.db'),
      path.join(process.cwd(), '.hive-flow', 'memory', 'agentdb.db'),
    ];
    ...
    if (agentdbStats.vectorCount === 0) {
      const agentdbDirs = [
        path.join(process.cwd(), '.hive-flow', 'agentdb'),
    ...
    const hnswPaths = [
      path.join(process.cwd(), '.hive-flow', 'hnsw'),
    ...
    const vectorsPath = path.join(process.cwd(), '.hive-flow', 'vectors.json');
...
const routeTaskCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks route-task --auto-swarm true', description: 'Route with auto-swarm (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionStartCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks session-start --auto-configure true', description: 'Start session (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const tokenOptimizeCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks token-optimize --stats', description: 'Show token savings stats' },
    { command: 'hive-flow hooks token-optimize -q "auth patterns"', description: 'Get compact context' },
    { command: 'hive-flow hooks token-optimize -A 8 --report', description: 'Config for 8 agents + report' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const modelStatsCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks model-stats', description: 'View routing stats' },
    { command: 'hive-flow hooks model-stats --detailed', description: 'Show detailed breakdown' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const result = await callMCPTool<{
...
const teammateIdleCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks teammate-idle --auto-assign true', description: 'Auto-assign tasks to idle teammate' },
    { command: 'hive-flow hooks teammate-idle -t worker-1 --check-task-list', description: 'Check tasks for specific teammate' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const taskCompletedCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks task-completed -i task-123 --train-patterns', description: 'Complete task and train patterns' },
    { command: 'hive-flow hooks task-completed -i task-456 --notify-lead --quality 0.95', description: 'Complete with quality score' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const hooksCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'hive-flow hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'hive-flow hooks pretrain', description: 'Bootstrap intelligence from repository' },
    { command: 'hive-flow hooks metrics --v3-dashboard', description: 'View V3 performance metrics' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Usage: hive-flow hooks <subcommand> [options]');
    output.writeln();
    output.writeln('Subcommands:');
    output.printList([
    ...
    output.writeln();
    output.writeln('Run "hive-flow hooks <subcommand> --help" for subcommand help');
    output.writeln();
