...
export const benchmarkCommand: Command = {
  ...
  examples: [
    { command: 'hive-flow ruvector benchmark', description: 'Run default benchmark' },
    { command: 'hive-flow ruvector benchmark --vectors 50000', description: 'Benchmark with 50k vectors' },
    { command: 'hive-flow ruvector benchmark --index ivfflat', description: 'Test IVFFlat index' },
    { command: 'hive-flow ruvector benchmark --dimensions 768 --metric l2', description: 'Custom dimensions and metric' },
  ],
