...
async function demo() {
  console.log('');
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  HIVE FLOW V3 - IPFS PLUGIN STORE DEMO                     ║');
  ...
  if (pluginCreator) {
    ...
    console.log('   $ hive-flow plugins install -n plugin-creator');
    console.log('');
  }
  ...
  console.log('   $ hive-flow plugins list              # List all plugins');
  console.log('   $ hive-flow plugins list --official   # Official only');
  console.log('   $ hive-flow plugins search -q neural  # Search plugins');
  console.log('   $ hive-flow plugins info -n plugin-creator');
  console.log('   $ hive-flow plugins install -n plugin-creator');
  console.log('');
}
