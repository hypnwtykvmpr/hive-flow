...
async function main() {
  console.log('');
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  HIVE FLOW V3 - STANDALONE PLUGIN STORE TEST               ║');
  ...
  try {
    ...
    console.log(`  ✅ Found ${similar.length} similar plugins to @hive-flow/embeddings`);
    passed++;
  } catch (e) {
    console.log(`  ❌ Failed: ${(e as Error).message}`);
    failed++;
  ...
  if (failed === 0) {
    ...
    console.log('    npx @hive-flow/cli plugins list');
    console.log('    npx @hive-flow/cli plugins list --official');
    console.log('    npx @hive-flow/cli plugins search -q "plugin creator"');
    console.log('    npx @hive-flow/cli plugins info -n plugin-creator');
    console.log('');
  }
