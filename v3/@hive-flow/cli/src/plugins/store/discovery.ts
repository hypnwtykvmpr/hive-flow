...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['@hive-flow/plugin-agentic-qe', '@hive-flow/plugin-prime-radiant', '@hive-flow/security', '@hive-flow/claims', '@hive-flow/teammate-plugin'],
      ...
      official: ['@hive-flow/plugin-agentic-qe', '@hive-flow/plugin-prime-radiant', '@hive-flow/security', '@hive-flow/claims'],
      compatibilityMatrix: [
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      ...
      {
        id: '@hive-flow/performance',
        name: '@hive-flow/performance',
