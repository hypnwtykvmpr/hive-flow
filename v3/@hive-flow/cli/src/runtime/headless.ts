...
function showHelp(): void {
  console.log(`
Headless Runtime for Hive Flow V3
...
Environment:
  HIVE_FLOW_HEADLESS=true   Enable headless mode
...
async function runBenchmarks(): Promise<BenchmarkResults> {
  console.log('=== Hive Flow V3 Performance Benchmarks ===\n');
...
async function showStatus(): Promise<void> {
  console.log('=== Hive Flow V3 System Status ===\n');
  ...
  console.log('\nEnvironment:');
  console.log(`  HIVE_FLOW_HEADLESS: ${process.env.HIVE_FLOW_HEADLESS || 'not set'}`);
...
async function main(): Promise<void> {
  ...
  process.env.HIVE_FLOW_HEADLESS = 'true';
