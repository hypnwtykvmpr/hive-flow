 ...
 * Modernized CLI for Hive Flow V3
 *
...
export class CLI {
  ...
  constructor(options: CLIOptions = {}) {
    this.name = options.name || 'hive-flow';
    this.description = options.description || 'Hive Flow V3 - AI Agent Orchestration Platform';
  ...
  private showHelp(): void {
    ...
    this.output.writeln();
    this.output.writeln(this.output.dim('Created by Hive Flow'));
    this.output.writeln();
  }
