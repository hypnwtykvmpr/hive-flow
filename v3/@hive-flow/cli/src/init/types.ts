...
export interface InitComponents {
  ...
  mcp: boolean;
  /** Create .hive-flow/ directory (V3 runtime) */
  runtime: boolean;
...
/**
 * Runtime configuration (.hive-flow/)
 */
export interface RuntimeConfig {
  ...
  /** Enable LearningBridge (ADR-049) - connects insights to ReasoningBank and local patterns */
