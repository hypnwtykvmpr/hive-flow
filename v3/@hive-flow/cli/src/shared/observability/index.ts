 ...
 * Lightweight tracing, metrics, and diagnostics for Hive Flow.
 *
 * Inspired by CodeMachine-CLI's OTEL stack but implemented without
 * OTEL SDK dependencies. Uses Hive Flow's EventBus for event propagation.
 *
 * @module @hive-flow/cli/shared/observability
 */
