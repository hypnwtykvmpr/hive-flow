/**
 * Local LLM GGUF Inference Engine -- Pure Node.js GGUF Model Interface
 *
 * Provides:
 ...
 *
 * @module @hive-flow/cli/appliance/gguf-engine
 */
...
export class GgufEngine {
  ...
  private async tryLoadLlamaCpp(): Promise<any> {
    // @ts-ignore — node-llama-cpp is an optional native dependency
