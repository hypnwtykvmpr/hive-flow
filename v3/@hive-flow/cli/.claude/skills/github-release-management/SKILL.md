...
[Single Message - Multi-Package Release]:
  ...
  mcp__hive-flow__swarm_init { topology: "mesh", maxAgents: 8 }
...
[Single Message - Cross-Repo Release]:
  ...
  mcp__hive-flow__swarm_init { topology: "star", maxAgents: 6 }
  ...
  mcp__hive-flow__swarm_monitor { interval: 5, duration: 300 }
```
