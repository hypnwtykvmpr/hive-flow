...
hooks:
  ...
  post: |
    ...
    mcp__hive-flow__memory_usage --action="store" --namespace="audit" --key="auth:$(date +%s)" --value="$AUTH_DECISION"
---
...
# Query audit log
mcp__hive-flow__memory_search --pattern="auth:*" --namespace="audit" --limit=100
```
