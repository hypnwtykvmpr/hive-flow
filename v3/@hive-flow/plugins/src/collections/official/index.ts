...
/**
 * Core collection - essential plugins for Hive Flow operation.
 */
export const coreCollection: PluginCollection = {
  id: 'hive-flow-core',
  name: 'Hive Flow Core Plugins',
  version: '3.0.0',
  description: 'Essential plugins for Hive Flow operation',
  author: 'Hive Flow',
  license: 'MIT',
