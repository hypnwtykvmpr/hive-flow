...
| Version | 1.0.0 |
| Status | Draft |
| Author | Hive Flow Architecture Team |
...
```
@hive-flow/plugins/src/integrations/ruvector/
|
...
```typescript
import { BasePlugin } from '@hive-flow/plugins';
