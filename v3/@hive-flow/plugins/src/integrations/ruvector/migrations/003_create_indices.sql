...
-- RuVector PostgreSQL Bridge - Hive Flow V3
--
...
CREATE INDEX IF NOT EXISTS idx_vectors_ns_coll_created
    ON hive_flow.vectors (namespace, collection, created_at DESC);

-- Embeddings: namespace + importance + access_count (for prioritization)
CREATE INDEX IF NOT EXISTS idx_embeddings_ns_importance
    ON hive_flow.embeddings (namespace, importance DESC, access_count DESC);
...
ANALYZE hive_flow.vectors;
ANALYZE hive_flow.embeddings;
ANALYZE hive_flow.attention_cache;
ANALYZE hive_flow.gnn_cache;
ANALYZE hive_flow.hyperbolic_embeddings;
ANALYZE hive_flow.collections;

-- ----------------------------------------------------------------------------
-- Record migration
-- ----------------------------------------------------------------------------
INSERT INTO hive_flow.migrations (name, checksum)
...
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_ns_importance;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_ns_coll_created;
--
-- -- Drop partial indices
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_high_importance;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_active;
--
-- -- Drop access pattern indices
-- DROP INDEX IF EXISTS hive_flow.idx_gnn_cache_hit_count;
-- DROP INDEX IF EXISTS hive_flow.idx_attention_cache_hit_count;
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_access_count;
--
-- -- Drop hierarchy indices
-- DROP INDEX IF EXISTS hive_flow.idx_hyperbolic_depth;
-- DROP INDEX IF EXISTS hive_flow.idx_hyperbolic_parent;
--
-- -- Drop hash indices
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_source;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_hash;
--
-- -- Drop timestamp indices
-- DROP INDEX IF EXISTS hive_flow.idx_collections_created_at;
-- DROP INDEX IF EXISTS hive_flow.idx_hyperbolic_created_at;
-- DROP INDEX IF EXISTS hive_flow.idx_gnn_cache_last_accessed;
-- DROP INDEX IF EXISTS hive_flow.idx_gnn_cache_created_at;
-- DROP INDEX IF EXISTS hive_flow.idx_attention_cache_last_accessed;
-- DROP INDEX IF EXISTS hive_flow.idx_attention_cache_created_at;
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_last_accessed;
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_created_at;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_expires_at;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_updated_at;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_created_at;
--
-- -- Drop namespace indices
-- DROP INDEX IF EXISTS hive_flow.idx_collections_namespace;
-- DROP INDEX IF EXISTS hive_flow.idx_hyperbolic_namespace;
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_tags_gin;
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_namespace;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_namespace;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_namespace_collection;
--
-- -- Drop GIN indices
-- DROP INDEX IF EXISTS hive_flow.idx_collections_metadata_gin;
-- DROP INDEX IF EXISTS hive_flow.idx_hyperbolic_metadata_gin;
-- DROP INDEX IF EXISTS hive_flow.idx_gnn_cache_metadata_gin;
-- DROP INDEX IF EXISTS hive_flow.idx_attention_cache_metadata_gin;
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_metadata_gin;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_metadata_gin;
--
-- -- Drop HNSW indices
-- DROP INDEX IF EXISTS hive_flow.idx_embeddings_embedding_hnsw_cosine;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_embedding_hnsw_ip;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_embedding_hnsw_l2;
-- DROP INDEX IF EXISTS hive_flow.idx_vectors_embedding_hnsw_cosine;
--
-- DELETE FROM hive_flow.migrations WHERE name = '003_create_indices';
-- COMMIT;
