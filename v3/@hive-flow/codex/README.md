...
<p align="center">
  ...
  <a href="https://github.com/ruvnet/hive-flow"><img src="https://img.shields.io/badge/license-MIT-green" alt="license"></a>
...
| Traditional Codex | With Hive-Flow |
|-------------------|------------------|
...
| `.hive-flow/data/memory.db` | Vector memory database |
...
Both platforms share the same `.hive-flow/` runtime:
...
HIVE_FLOW_MEMORY_PATH=./.hive-flow/data
...
| Speed Improvement | HNSW-indexed retrieval |
