...
This document describes how the Quality Engineering (agentic-qe) plugin integrates with Hive Flow V3's existing domains: Security, Core, Memory, Integration, and Coordination.
...
│   │   Translates between agentic-qe and hive-flow V3 domains              │   │
│   └─────────────────────────────────────────────────────────────────────────┘   │
│                                        │                                         │
│     ┌──────────────┬──────────────────┼──────────────────┬──────────────┐       │
│     │              │                  │                  │              │       │
...
The QE domain reuses V3's `@hive-flow/embeddings` service instead of running separate `@xenova/transformers` instances:
...
import type { AgentService, TaskService, WorkflowService } from '@hive-flow/core';
...
import type { HiveMindService, ConsensusResult } from '@hive-flow/coordination';
