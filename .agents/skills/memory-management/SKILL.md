...
description: >
  AgentDB memory system with HNSW vector search. Provides fast HNSW-indexed pattern retrieval, persistent storage, and semantic search capabilities for learning and knowledge management.
