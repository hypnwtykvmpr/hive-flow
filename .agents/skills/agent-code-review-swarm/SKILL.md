...
tools: mcp__hive-flow__swarm_init, mcp__hive-flow__agent_spawn, mcp__hive-flow__task_orchestrate, Bash, Read, Write, TodoWrite
color: blue
type: development
capabilities:
...
npx hive-flow github review-orchestrate \
  --strategy "risk-based" \
