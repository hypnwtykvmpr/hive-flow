...
description: "CLI modernization and hooks system enhancement for hive-flow v3. Implements interactive prompts, command decomposition, enhanced hooks integration, and intelligent workflow automation."
---
...
Modernizes hive-flow v3 CLI with interactive prompts, intelligent command decomposition, enhanced hooks integration, performance optimization, and comprehensive workflow automation capabilities.
...
hive-flow swarm init --interactive
hive-flow learning start --guided
hive-flow workflow create --from-intent "setup new project"
```