...
## Purpose
Multi-package synchronization and version alignment with hive-flow coordination for seamless integration between claude-code-flow and hive-flow packages through intelligent multi-agent orchestration.
...
- `mcp__github__create_pull_request`
- `mcp__github__search_repositories`
- `mcp__hive-flow__*` (all swarm coordination tools)
...
mcp__hive-flow__swarm_init { topology: "hierarchical", maxAgents: 5 }
mcp__hive-flow__agent_spawn { type: "coordinator", name: "Sync Coordinator" }
mcp__hive-flow__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__hive-flow__agent_spawn { type: "coder", name: "Integration Developer" }
...
[Single Message - Complete Synchronization]:
  ...
  mcp__hive-flow__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
  mcp__hive-flow__agent_spawn { type: "analyst", name: "Package Analyzer" }
...
mcp__hive-flow__swarm_init { topology: "hierarchical", maxAgents: 10 }
mcp__hive-flow__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
mcp__hive-flow__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__hive-flow__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__hive-flow__agent_spawn { type: "tester", name: "Validation Engineer" }
mcp__hive-flow__agent_spawn { type: "reviewer", name: "Quality Assurance" }
mcp__hive-flow__agent_spawn { type: "monitor", name: "Sync Monitor" }
...
const syncConflictResolver = async (conflicts) => {
  ...
  await mcp__hive_flow__swarm_init({ topology: "mesh", maxAgents: 6 });

  // Spawn specialized conflict resolution agents
  await mcp__hive_flow__agent_spawn({ type: "analyst", name: "Conflict Analyzer" });
  await mcp__hive_flow__agent_spawn({ type: "coder", name: "Resolution Developer" });
  await mcp__hive_flow__agent_spawn({ type: "reviewer", name: "Solution Validator" });
  ...
  return await mcp__hive_flow__task_orchestrate({
...
mcp__hive-flow__memory_usage {
  ...
  value: {
    packages_synchronized: ["claude-code-flow", "hive-flow"],
...
mcp__hive-flow__swarm_init { topology: "star", maxAgents: 5 }
mcp__hive-flow__agent_spawn { type: "monitor", name: "Error Monitor" }
mcp__hive-flow__agent_spawn { type: "analyst", name: "Failure Analyzer" }
mcp__hive-flow__agent_spawn { type: "coder", name: "Recovery Developer" }

# Coordinate recovery procedures
mcp__hive-flow__coordination_sync { swarmId: "error-recovery-swarm" }
