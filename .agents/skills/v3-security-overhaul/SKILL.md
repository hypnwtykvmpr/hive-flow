...
description: "Complete security architecture overhaul for hive-flow v3. Addresses critical CVEs (CVE-1, CVE-2, CVE-3) and implements secure-by-default patterns. Use for security-first v3 implementation."
---
...
Orchestrates comprehensive security overhaul for hive-flow v3, addressing critical vulnerabilities and establishing security-first development practices using specialized v3 security agents.
