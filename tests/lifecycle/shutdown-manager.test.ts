...
import { ShutdownManager, ShutdownEvents } from '../../v3/@claude-flow/shared/src/lifecycle/shutdown-manager.js';
import { ProcessGroupManager } from '../../v3/@claude-flow/shared/src/lifecycle/process-group-manager.js';
import { ResourceCleaner } from '../../v3/@claude-flow/shared/src/lifecycle/resource-cleaner.js';
