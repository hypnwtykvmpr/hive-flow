...
npx hive-flow test:integration:auth & \
npx hive-flow test:integration:data & \
npx hive-flow test:integration:storage & \
wait
```
...
1. Run directly: `npx hive-flow sparc run mcp-optimized "your task"`
...
npx hive-flow sparc run mcp-optimized "integrate auth, payment, and notification services"

# Batch API configuration
npx hive-flow sparc run mcp-optimized "configure all external service endpoints"
```
