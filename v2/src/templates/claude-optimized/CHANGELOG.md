...
- Hive Flow integration commands:
  - hive-flow-help - Help and documentation access
  - hive-flow-memory - Memory system interaction
  - hive-flow-swarm - Swarm coordination
- SPARC mode commands:
...
- Integrated with Hive Flow orchestration
