...
export interface HiveFlowToolContext extends MCPContext {
...
/**
 * Create all Hive-Flow specific MCP tools
 */
export async function createHiveFlowTools(logger: ILogger): Promise<MCPTool[]> {
  const tools = [
...
function createSpawnAgentTool(logger: ILogger): MCPTool {
  return {
    ...
    handler: async (input: any, context?: HiveFlowToolContext) => {
