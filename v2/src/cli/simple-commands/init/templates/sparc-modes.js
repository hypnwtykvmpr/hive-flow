...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow swarm "build feature X" --strategy development
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow swarm "build feature X" --strategy development
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow swarm "test application" --strategy testing
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow swarm "test application" --strategy testing
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run analyzer "analyze codebase performance"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run analyzer "analyze codebase performance"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run architect "design microservices architecture"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run architect "design microservices architecture"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run coder "implement user authentication"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run coder "implement user authentication"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run debugger "fix authentication issues"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run debugger "fix authentication issues"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run designer "create dashboard UI"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run designer "create dashboard UI"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run documenter "create API documentation"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run documenter "create API documentation"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run memory-manager "organize project knowledge"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run memory-manager "organize project knowledge"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run reviewer "review pull request #123"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run reviewer "review pull request #123"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run swarm-coordinator "manage development swarm"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run swarm-coordinator "manage development swarm"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run tdd "shopping cart feature"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run tdd "shopping cart feature"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow sparc run tester "full regression suite"
...
\`\`\`bash
# If hive-flow is installed locally
./hive-flow sparc run tester "full regression suite"
\`\`\`
