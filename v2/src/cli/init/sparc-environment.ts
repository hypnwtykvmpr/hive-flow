...
This CLAUDE.md file configures Claude Code to help you BUILD YOUR OWN APPLICATIONS using the hive-flow orchestration system. Claude-flow is a tool to help you develop software - it is NOT the project you should be modifying.

**IMPORTANT**: 
- Use hive-flow commands to BUILD YOUR APPLICATION
- DO NOT modify the hive-flow system itself
...
Configure these for YOUR application (not hive-flow):
...
## 🚀 Using Hive-Flow to Build Your Application

Hive-flow provides powerful AI orchestration tools to accelerate YOUR application development. Use these commands to build YOUR project:

### 🎮 Getting Started with Your Project
- \`./hive-flow start --ui\`: Start the AI orchestration system to help build YOUR app
- \`./hive-flow sparc "Build a [YOUR APP TYPE] application"\`: Start building YOUR application
- \`./hive-flow swarm "Create [YOUR FEATURE]"\`: Use multiple AI agents to build complex features
- \`./hive-flow status\`: Check the status of YOUR development tasks

### 🤖 AI Agents to Build Your Application
- \`./hive-flow agent spawn coder\`: Create a coding agent for YOUR project
- \`./hive-flow agent spawn researcher\`: Research best practices for YOUR features
- \`./hive-flow agent spawn tester\`: Create tests for YOUR application
- \`./hive-flow agent list\`: See agents working on YOUR project

### 📋 Managing Your Development Tasks
- \`./hive-flow task create feature "Add user authentication to my app"\`: Create development tasks
- \`./hive-flow task list\`: View YOUR project's task queue
- \`./hive-flow workflow my-app-workflow.json\`: Automate YOUR development workflow

### 🧠 Project Knowledge Management
- \`./hive-flow memory store "my_app_architecture" "REST API with React frontend"\`: Store YOUR project decisions
- \`./hive-flow memory get "my_app_requirements"\`: Retrieve YOUR project information
- \`./hive-flow memory list\`: See all stored knowledge about YOUR project
- \`./hive-flow memory export my-project-knowledge.json\`: Export YOUR project knowledge

### 🎯 SPARC Modes for Building Your Application
- \`./hive-flow sparc "Create a todo list app with React"\`: Start building YOUR app
- \`./hive-flow sparc run coder "Implement user login for my app"\`: Code YOUR features
- \`./hive-flow sparc tdd "Shopping cart functionality"\`: Build YOUR features test-first
- \`./hive-flow sparc run architect "Design my app's database schema"\`: Design YOUR architecture
...
\`./hive-flow swarm "Build a complete e-commerce website" --strategy development --parallel\`
...
./hive-flow sparc "Create a task management web app with React and Node.js"

# Add authentication to YOUR app
./hive-flow sparc run coder "Add user authentication with JWT tokens to my task app"

# Create tests for YOUR features
./hive-flow sparc tdd "Task creation and assignment features"

# Use multiple agents to build faster
./hive-flow swarm "Build complete task management system" --strategy development --parallel
\`\`\`

### 🔍 Research Phase for Your Project
\`\`\`bash
# Research best practices for YOUR app type
./hive-flow sparc run researcher "Research best practices for building SaaS applications"

# Store YOUR project's technical decisions
./hive-flow memory store "tech_stack" "React, Node.js, PostgreSQL, Redis"
./hive-flow memory store "auth_strategy" "JWT with refresh tokens"

# Analyze similar applications
./hive-flow sparc run analyzer "Analyze successful task management apps for feature ideas"
\`\`\`

### 🏗️ Development Workflow for Your Application
\`\`\`bash
# Design YOUR application architecture
./hive-flow sparc run architect "Design microservices architecture for my e-commerce platform"

# Implement YOUR features with TDD
./hive-flow sparc tdd "Shopping cart with discount calculation"

# Multiple agents working on YOUR project
./hive-flow swarm "Build user dashboard with analytics" --strategy development --max-agents 5

# Review and optimize YOUR code
./hive-flow sparc run reviewer "Review authentication implementation for security"
\`\`\`

### 🔧 Testing and Debugging Your Application
\`\`\`bash
# Comprehensive testing for YOUR app
./hive-flow sparc run tester "Create comprehensive test suite for my API endpoints"

# Debug issues in YOUR application
./hive-flow sparc run debugger "Debug why user login is failing in production"

# Performance optimization for YOUR app
./hive-flow sparc run optimizer "Optimize database queries in my application"

# Security review for YOUR project
./hive-flow sparc run reviewer "Security audit of my payment processing system"
\`\`\`

### 📚 Documentation for Your Project
\`\`\`bash
# Generate documentation for YOUR API
./hive-flow sparc run documenter "Create API documentation for my REST endpoints"

# Document YOUR project architecture
./hive-flow sparc run documenter "Document the system architecture and design decisions"

# Create user guides for YOUR application
./hive-flow sparc run documenter "Write user guide for the admin dashboard"
\`\`\`
...
./hive-flow memory store "app_type" "SaaS project management tool"
./hive-flow memory store "target_users" "Small to medium development teams"
./hive-flow memory store "core_features" "Task tracking, team collaboration, time tracking, reporting"

# Design YOUR architecture based on requirements
./hive-flow sparc run architect "Design scalable SaaS architecture for project management tool"

# Research best practices for YOUR app type
./hive-flow sparc run researcher "Research best practices for multi-tenant SaaS applications"
\`\`\`
...
./hive-flow sparc tdd "User registration and team creation"
./hive-flow sparc run coder "Implement project and task management features"

# Phase 2: Advanced features
./hive-flow swarm "Build real-time collaboration features" --strategy development --parallel
./hive-flow sparc run coder "Add time tracking and reporting dashboard"

# Phase 3: Polish and optimize
./hive-flow sparc run optimizer "Optimize performance for 1000+ concurrent users"
./hive-flow sparc run designer "Improve UI/UX for mobile responsiveness"
\`\`\`
...
./hive-flow sparc run tester "Complete end-to-end testing suite"
./hive-flow sparc run reviewer "Final security audit before launch"

# Documentation for YOUR users
./hive-flow sparc run documenter "Create user documentation and API guides"

# Performance optimization
./hive-flow sparc run optimizer "Optimize for production deployment"
\`\`\`

## 🛠️ How Claude Code Helps Build YOUR Application

### 🤖 AI-Powered Development Assistance
When you use hive-flow commands, Claude Code will help you:
- **Write code** for YOUR application (not for hive-flow itself)
...
./hive-flow swarm "Build complete e-commerce platform with payment integration" \\
  --strategy development --parallel --max-agents 8

# Example: Adding real-time features to YOUR app
./hive-flow swarm "Add real-time chat and notifications to my app" \\
  --strategy development --parallel --max-agents 5

# Example: Comprehensive testing of YOUR application
./hive-flow swarm "Create comprehensive test suite for my API" \\
...
### ❌ DON'T Use Hive-Flow For:
- Modifying the hive-flow system itself
- Changing how hive-flow works internally
- Updating hive-flow commands or features
- Fixing hive-flow bugs (report them on GitHub instead)

## 🎉 Get Started Building YOUR Application!

Remember: Hive-flow is a TOOL to help you build YOUR application faster and better. Focus on describing what YOU want to build, and let the AI agents help you create it.

**Example first command for a new project:**
\`\`\`bash
./hive-flow sparc "Create a [YOUR APP TYPE] application with [YOUR MAIN FEATURES]"
\`\`\`
