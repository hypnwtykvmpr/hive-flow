...
async function showBasicInterface(options: FallbackOptions): Promise<void> {
  ...
  console.log(chalk.gray('   ./hive-flow status'));
  console.log(chalk.gray('   ./hive-flow memory list'));
  console.log(chalk.gray('   ./hive-flow sparc modes'));
  console.log();
  console.log(chalk.white('2. Use non-interactive modes:'));
  console.log(chalk.gray('   ./hive-flow start (without --ui)'));
  console.log(chalk.gray('   ./hive-flow swarm "task" --monitor'));
  console.log();
  ...
  if (options.showHelp) {
    ...
    console.log(chalk.gray('   ./hive-flow help <command>'));
    console.log(chalk.gray('   ./hive-flow <command> --help'));
    console.log();
  }
