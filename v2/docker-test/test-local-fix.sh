#!/bin/bash
# Test script for LOCAL hive-flow (skills-copier fix validation)

set -e  # Exit on error

echo "=========================================="
echo "🔧 Testing LOCAL hive-flow Skills Fix"
echo "=========================================="
echo ""
...
info "Running: npx hive-flow init --skip-open --project-name test-project"
npx hive-flow init --skip-open --project-name "test-project" 2>&1 | tee /tmp/init-output.log
