...
async function analyzeResults() {
  try {
    ...
    console.log("📊 Hive-Flow Parallel Agent Test Results Analysis");
...
async function generateDetailedReport(results: FullResults) {
  const report = `# Hive-Flow Parallel Agent Test Report
...
---
*Report generated by Hive-Flow Parallel Test Suite*
`;
