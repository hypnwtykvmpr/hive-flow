...
# Hive Flow Examples - Quick Start Guide
# This script demonstrates the new organized example structure

echo "🚀 Hive Flow Examples - Quick Start"
echo "===================================="
echo ""
...
echo "cd examples && ../hive-flow swarm create 'Build hello world app based on simple workflow' --output ./output/hello"
echo ""
echo "# Run tests:"
echo "cd examples/04-testing/unit && ./test-memory-system.sh"
echo ""
echo "# Create your first swarm:"
echo "cd examples && ../hive-flow swarm create 'Build a simple calculator'"
echo ""
echo "# Try SPARC TDD:"
echo "cd examples && ../hive-flow sparc tdd 'Create user login function'"
echo ""
