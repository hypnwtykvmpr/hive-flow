# Release Notes: Hive Flow v2.7.33
...
### Overview
Full implementation of MCP (Model Context Protocol) 2025-11 specification, aligning Hive Flow with Anthropic's latest standards for AI model interaction.
...
npx hive-flow mcp start --mcp2025 --transport http --port 3000
...
# Verify version
npx hive-flow --version  # Should show v2.7.33
```
...
npx hive-flow mcp start --mcp2025 --transport stdio
```
...
2. Include version (`npx hive-flow --version`)
...
Hive Flow v2.7.33 is a **major feature release** that brings:
...
**This release positions Hive Flow as an industry-leading AI agent orchestration platform** with cutting-edge features, massive performance improvements, and enterprise-grade reliability.
