...
```bash
# Usage example
npx hive-flow@alpha github gh-coordinator \
...
npx hive-flow@alpha github repo-architect \
...
npx hive-flow@alpha github ci-orchestrator \
...
npx hive-flow@alpha github sync-coordinator \
