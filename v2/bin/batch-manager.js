...
async function createInteractiveConfig(outputFile) {
  ...
  try {
    ...
    console.log(`4. Run: hive-flow init --config ${outputFile}`);
  } catch (error) {
...
function showBatchManagerHelp() {
  ...
  console.log('USAGE:');
  console.log('  hive-flow batch <command> [options]\n');
  ...
  console.log('  hive-flow batch create-config my-batch.json');
  console.log('  hive-flow batch create-config --interactive');
  console.log('  hive-flow batch validate-config my-batch.json');
  console.log('  hive-flow batch estimate my-batch.json');
  console.log('  hive-flow batch list-templates');
  console.log('  hive-flow batch list-environments\n');

  console.log('INTEGRATION:');
  console.log('  Use created configs with: hive-flow init --config <file>');
  console.log('  Or batch init directly: hive-flow init --batch-init project1,project2');
}
