...
export class PostInitValidator {
  ...
  async checkFileIntegrity() {
    ...
    const expectedFiles = [
      ...
      { path: 'memory/hive-flow-data.json', minSize: 10 },
      { path: 'memory/agents/README.md', minSize: 10 },
      { path: 'memory/sessions/README.md', minSize: 10 },
      { path: 'hive-flow', minSize: 50, executable: true },
    ];
  ...
  async checkPermissions() {
    ...
    const itemsToCheck = [
      ...
      { path: 'hive-flow', type: 'file', requiredMode: 0o755 },
  ...
  async validateMemoryStructure() {
    ...
    const expectedFiles = ['hive-flow-data.json', 'agents/README.md', 'sessions/README.md'];
