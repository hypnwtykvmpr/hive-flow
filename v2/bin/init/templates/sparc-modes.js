...
\`\`\`bash
# Run a specific mode
./hive-flow@alpha sparc run <mode> "task description"

# List all modes
./hive-flow@alpha sparc modes

# Get help for a mode
./hive-flow@alpha sparc help <mode>
\`\`\`
`;
}
...
mcp__hive-flow@alpha__task_orchestrate {
...
npx hive-flow@alpha swarm "analyze system performance" --strategy analysis
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha swarm "analyze system performance" --strategy analysis
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha swarm "build feature X" --strategy development
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha swarm "build feature X" --strategy development
\`\`\`
...
### Research Swarm
\`\`\`bash
./hive-flow@alpha swarm "research AI trends" \\
  --strategy research \\
  --mode distributed \\
  --max-agents 6 \\
  --parallel
...
### Development Swarm
\`\`\`bash
./hive-flow@alpha swarm "build REST API" \\
  --strategy development \\
  --mode hierarchical \\
  --monitor \\
  --output sqlite
...
### Analysis Swarm
\`\`\`bash
./hive-flow@alpha swarm "analyze codebase" \\
  --strategy analysis \\
  --mode mesh \\
  --parallel \\
  --timeout 300
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha swarm "update dependencies" --strategy maintenance
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha swarm "update dependencies" --strategy maintenance
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha swarm "optimize performance" --strategy optimization
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha swarm "optimize performance" --strategy optimization
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha swarm "research topic X" --strategy research
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha swarm "research topic X" --strategy research
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha swarm "test application" --strategy testing
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha swarm "test application" --strategy testing
\`\`\`
...
### Option 1: Using MCP Tools (Preferred in Claude Code)
\`\`\`javascript
mcp__hive-flow@alpha__sparc_mode {
  mode: "analyzer",
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run analyzer "analyze codebase performance"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run analyzer "analyze codebase performance"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run architect "design microservices architecture"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run architect "design microservices architecture"
\`\`\`
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run batch-executor "process multiple files"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run coder "implement user authentication"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run coder "implement user authentication"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run debugger "fix authentication issues"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run debugger "fix authentication issues"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run designer "create dashboard UI"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run designer "create dashboard UI"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run documenter "create API documentation"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run documenter "create API documentation"
\`\`\`
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run innovator "innovative solutions for scaling"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run memory-manager "organize project knowledge"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run memory-manager "organize project knowledge"
\`\`\`
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run optimizer "optimize application performance"
\`\`\`
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run orchestrator "coordinate feature development"
\`\`\`
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run researcher "research AI trends 2024"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run reviewer "review pull request #123"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run reviewer "review pull request #123"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run swarm-coordinator "manage development swarm"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run swarm-coordinator "manage development swarm"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run tdd "shopping cart feature"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run tdd "shopping cart feature"
\`\`\`
...
\`\`\`bash
# Use when running from terminal or MCP tools unavailable
npx hive-flow@alpha sparc run tester "full regression suite"
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run tester "full regression suite"
\`\`\`
...
\`\`\`bash
# If hive-flow@alpha is installed locally
./hive-flow@alpha sparc run workflow-manager "automate deployment"
\`\`\`
