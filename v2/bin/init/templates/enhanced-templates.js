// enhanced-templates.js - Generate Hive Flow v2.0.0 enhanced templates
...
export function createWrapperScript(type = 'unix') {
  ...
  if (type === 'unix') {
    const universalTemplate = loadTemplate('hive-flow@alpha-universal');
  ...
  const filename = 'hive-flow@alpha';
...
## Usage
\`\`\`bash
npx hive-flow@alpha analysis bottleneck-detect [options]
\`\`\`
...
npx hive-flow@alpha analysis bottleneck-detect

# Set custom threshold
npx hive-flow@alpha analysis bottleneck-detect --threshold 500

# Export results
npx hive-flow@alpha analysis bottleneck-detect --export bottlenecks.json
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha analysis token-usage [options]
\`\`\`
...
npx hive-flow@alpha analysis token-usage --period 24h

# By agent breakdown
npx hive-flow@alpha analysis token-usage --by-agent

# Export detailed report
npx hive-flow@alpha analysis token-usage --period 7d --export tokens.csv
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha analysis performance-report [options]
\`\`\`
...
npx hive-flow@alpha analysis performance-report --format html

# Compare swarms
npx hive-flow@alpha analysis performance-report --compare swarm-123

# Full metrics report
npx hive-flow@alpha analysis performance-report --include-metrics --format markdown
\`\`\`
`,
    },
    automation: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha automation auto-agent [options]
\`\`\`
...
npx hive-flow@alpha automation auto-agent --task "Build REST API"

# Limit agents
npx hive-flow@alpha automation auto-agent --task "Fix bugs" --max-agents 3

# Use specific strategy
npx hive-flow@alpha automation auto-agent --strategy specialized
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha automation smart-spawn [options]
\`\`\`
...
npx hive-flow@alpha automation smart-spawn --analyze

# Set spawn threshold
npx hive-flow@alpha automation smart-spawn --threshold 5

# Force topology
npx hive-flow@alpha automation smart-spawn --topology hierarchical
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha automation workflow-select [options]
\`\`\`
...
npx hive-flow@alpha automation workflow-select --task "Deploy to production"

# With constraints
npx hive-flow@alpha automation workflow-select --constraints "no-downtime,rollback"

# Preview mode
npx hive-flow@alpha automation workflow-select --task "Database migration" --preview
\`\`\`
`,
    },
    coordination: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha swarm init [options]
\`\`\`
...
# With agent limit
npx hive-flow@alpha swarm init --topology mesh --max-agents 8

# Parallel execution
npx hive-flow@alpha swarm init --strategy parallel
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha agent spawn [options]
\`\`\`
...
\`\`\`bash
# Spawn coder agent
npx hive-flow@alpha agent spawn --type coder

# With custom name
npx hive-flow@alpha agent spawn --type researcher --name "API Expert"

# With specific skills
npx hive-flow@alpha agent spawn --type coder --skills "python,fastapi,testing"
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha task orchestrate [options]
\`\`\`
...
npx hive-flow@alpha task orchestrate --task "Implement user authentication"

# High priority task
npx hive-flow@alpha task orchestrate --task "Fix production bug" --priority critical

# With specific strategy
npx hive-flow@alpha task orchestrate --task "Refactor codebase" --strategy parallel
\`\`\`
`,
    },
    github: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha github swarm [options]
\`\`\`
...
\`\`\`bash
# Create GitHub swarm
npx hive-flow@alpha github swarm --repository myorg/myrepo

# With specific focus
npx hive-flow@alpha github swarm --repository myorg/myrepo --focus security

# Custom agent count
npx hive-flow@alpha github swarm --repository myorg/myrepo --agents 6
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha github repo-analyze [options]
\`\`\`
...
\`\`\`bash
# Basic analysis
npx hive-flow@alpha github repo-analyze --repository myorg/myrepo

# Deep analysis
npx hive-flow@alpha github repo-analyze --repository myorg/myrepo --deep

# Specific areas
npx hive-flow@alpha github repo-analyze --repository myorg/myrepo --include issues,prs
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha github pr-enhance [options]
\`\`\`
...
\`\`\`bash
# Enhance PR
npx hive-flow@alpha github pr-enhance --pr-number 123

# Add tests
npx hive-flow@alpha github pr-enhance --pr-number 123 --add-tests

# Full enhancement
npx hive-flow@alpha github pr-enhance --pr-number 123 --add-tests --improve-docs
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha github issue-triage [options]
\`\`\`
...
\`\`\`bash
# Triage issues
npx hive-flow@alpha github issue-triage --repository myorg/myrepo

# With auto-labeling
npx hive-flow@alpha github issue-triage --repository myorg/myrepo --auto-label

# Full automation
npx hive-flow@alpha github issue-triage --repository myorg/myrepo --auto-label --assign
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha github code-review [options]
\`\`\`
...
\`\`\`bash
# Review PR
npx hive-flow@alpha github code-review --pr-number 456

# Security focus
npx hive-flow@alpha github code-review --pr-number 456 --focus security

# With fix suggestions
npx hive-flow@alpha github code-review --pr-number 456 --suggest-fixes
\`\`\`
`,
    },
    hooks: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha hook pre-task [options]
\`\`\`
...
\`\`\`bash
# Basic pre-task hook
npx hive-flow@alpha hook pre-task --description "Building API endpoints"

# With auto-spawn
npx hive-flow@alpha hook pre-task --description "Complex refactoring" --auto-spawn-agents

# Load context
npx hive-flow@alpha hook pre-task --description "Continue feature" --load-context
\`\`\`
`,
      'post-task': `# post-task
...
## Usage
\`\`\`bash
npx hive-flow@alpha hook post-task [options]
\`\`\`
...
\`\`\`bash
# Basic post-task
npx hive-flow@alpha hook post-task --task-id task-123

# With performance analysis
npx hive-flow@alpha hook post-task --task-id task-123 --analyze-performance

# Update memory
npx hive-flow@alpha hook post-task --task-id task-123 --update-memory
\`\`\`
`,
      'pre-edit': `# pre-edit
...
## Usage
\`\`\`bash
npx hive-flow@alpha hook pre-edit [options]
\`\`\`
...
\`\`\`bash
# Pre-edit hook
npx hive-flow@alpha hook pre-edit --file src/api.js

# With validation
npx hive-flow@alpha hook pre-edit --file src/api.js --validate-syntax

# Create backup
npx hive-flow@alpha hook pre-edit --file src/api.js --backup
\`\`\`
`,
      'post-edit': `# post-edit
...
## Usage
\`\`\`bash
npx hive-flow@alpha hook post-edit [options]
\`\`\`
...
\`\`\`bash
# Post-edit hook
npx hive-flow@alpha hook post-edit --file src/api.js

# Store in memory
npx hive-flow@alpha hook post-edit --file src/api.js --memory-key "api-changes"

# With formatting
npx hive-flow@alpha hook post-edit --file src/api.js --format
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha hook session-end [options]
\`\`\`
...
\`\`\`bash
# End session
npx hive-flow@alpha hook session-end

# Export metrics
npx hive-flow@alpha hook session-end --export-metrics

# Full closure
npx hive-flow@alpha hook session-end --export-metrics --generate-summary --persist-state
\`\`\`
`,
    },
    memory: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha memory usage [options]
\`\`\`
...
\`\`\`bash
# Store memory
npx hive-flow@alpha memory usage --action store --key "project-config" --value '{"api": "v2"}'

# Retrieve memory
npx hive-flow@alpha memory usage --action retrieve --key "project-config"

# List all keys
npx hive-flow@alpha memory usage --action list
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha memory persist [options]
\`\`\`
...
\`\`\`bash
# Export memory
npx hive-flow@alpha memory persist --export memory-backup.json

# Import memory
npx hive-flow@alpha memory persist --import memory-backup.json

# Compressed export
npx hive-flow@alpha memory persist --export memory.gz --compress
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha memory search [options]
\`\`\`
...
\`\`\`bash
# Search memory
npx hive-flow@alpha memory search --query "authentication"

# Pattern search
npx hive-flow@alpha memory search --pattern "api-.*"

# Limited results
npx hive-flow@alpha memory search --query "config" --limit 10
\`\`\`
`,
    },
    monitoring: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha swarm monitor [options]
\`\`\`
...
\`\`\`bash
# Start monitoring
npx hive-flow@alpha swarm monitor

# Custom interval
npx hive-flow@alpha swarm monitor --interval 5000

# With metrics
npx hive-flow@alpha swarm monitor --metrics
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha agent metrics [options]
\`\`\`
...
\`\`\`bash
# All agents metrics
npx hive-flow@alpha agent metrics

# Specific agent
npx hive-flow@alpha agent metrics --agent-id agent-001

# Last hour
npx hive-flow@alpha agent metrics --period 1h
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha monitoring real-time-view [options]
\`\`\`
...
npx hive-flow@alpha monitoring real-time-view

# Filter errors
npx hive-flow@alpha monitoring real-time-view --filter errors

# Highlight pattern
npx hive-flow@alpha monitoring real-time-view --highlight "API"
\`\`\`
`,
    },
    optimization: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha optimization topology-optimize [options]
\`\`\`
...
\`\`\`bash
# Analyze and suggest
npx hive-flow@alpha optimization topology-optimize --analyze-first

# Optimize for speed
npx hive-flow@alpha optimization topology-optimize --target speed

# Apply changes
npx hive-flow@alpha optimization topology-optimize --target efficiency --apply
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha optimization parallel-execute [options]
\`\`\`
...
\`\`\`bash
# Execute task list
npx hive-flow@alpha optimization parallel-execute --tasks tasks.json

# Limit parallelism
npx hive-flow@alpha optimization parallel-execute --tasks tasks.json --max-parallel 5

# Custom strategy
npx hive-flow@alpha optimization parallel-execute --strategy adaptive
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha optimization cache-manage [options]
\`\`\`
...
\`\`\`bash
# View cache stats
npx hive-flow@alpha optimization cache-manage --action view

# Clear cache
npx hive-flow@alpha optimization cache-manage --action clear

# Set limits
npx hive-flow@alpha optimization cache-manage --max-size 100 --ttl 3600
\`\`\`
`,
    },
    training: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha training neural-train [options]
\`\`\`
...
npx hive-flow@alpha training neural-train --data recent

# Specific model
npx hive-flow@alpha training neural-train --model task-predictor

# Custom epochs
npx hive-flow@alpha training neural-train --epochs 100
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha training pattern-learn [options]
\`\`\`
...
\`\`\`bash
# Learn from all ops
npx hive-flow@alpha training pattern-learn

# High success only
npx hive-flow@alpha training pattern-learn --threshold 0.9

# Save patterns
npx hive-flow@alpha training pattern-learn --save optimal-patterns
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha training model-update [options]
\`\`\`
...
\`\`\`bash
# Update all models
npx hive-flow@alpha training model-update

# Specific model
npx hive-flow@alpha training model-update --model agent-selector

# Incremental with validation
npx hive-flow@alpha training model-update --incremental --validate
\`\`\`
`,
    },
    workflows: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha workflow create [options]
\`\`\`
...
\`\`\`bash
# Create workflow
npx hive-flow@alpha workflow create --name "deploy-api"

# From history
npx hive-flow@alpha workflow create --name "test-suite" --from-history

# Interactive mode
npx hive-flow@alpha workflow create --interactive
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha workflow execute [options]
\`\`\`
...
\`\`\`bash
# Execute workflow
npx hive-flow@alpha workflow execute --name "deploy-api"

# With parameters
npx hive-flow@alpha workflow execute --name "test-suite" --params '{"env": "staging"}'

# Dry run
npx hive-flow@alpha workflow execute --name "deploy-api" --dry-run
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha workflow export [options]
\`\`\`
...
\`\`\`bash
# Export workflow
npx hive-flow@alpha workflow export --name "deploy-api"

# As YAML
npx hive-flow@alpha workflow export --name "test-suite" --format yaml

# With history
npx hive-flow@alpha workflow export --name "deploy-api" --include-history
\`\`\`
`,
    },
    swarm: {
...
## Usage
\`\`\`bash
npx hive-flow@alpha swarm <objective> [options]
\`\`\`
...
\`\`\`bash
# Basic swarm
npx hive-flow@alpha swarm "Build REST API"

# With strategy
npx hive-flow@alpha swarm "Research AI patterns" --strategy research

# Open in Claude Code
npx hive-flow@alpha swarm "Build API" --claude
\`\`\`
`,
      'swarm-init': `# swarm-init
...
npx hive-flow@alpha swarm init --topology hierarchical --max-agents 8
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha swarm spawn [options]
\`\`\`
...
## Examples
\`\`\`bash
npx hive-flow@alpha swarm spawn --type coder --count 3
npx hive-flow@alpha swarm spawn --type researcher --capabilities "web-search,analysis"
\`\`\`
`,
    },
    'hive-mind': {
...
## Usage
\`\`\`bash
npx hive-flow@alpha hive-mind [subcommand] [options]
\`\`\`
...
npx hive-flow@alpha hive-mind init

# Spawn swarm
npx hive-flow@alpha hive-mind spawn "Build microservices"
...
## Usage
\`\`\`bash
npx hive-flow@alpha hive-mind init [options]
\`\`\`
...
\`\`\`bash
npx hive-flow@alpha hive-mind init
npx hive-flow@alpha hive-mind init --force
\`\`\`
`,
...
## Usage
\`\`\`bash
npx hive-flow@alpha hive-mind spawn <objective> [options]
\`\`\`
...
## Examples
\`\`\`bash
npx hive-flow@alpha hive-mind spawn "Build API"
npx hive-flow@alpha hive-mind spawn "Research patterns" --queen-type adaptive
npx hive-flow@alpha hive-mind spawn "Build service" --claude
\`\`\`
`,
    },
    agents: {
...
Complete guide to all 54 available agent types in Hive Flow.
...
npx hive-flow@alpha agents capabilities

# For specific agent
npx hive-flow@alpha agents capabilities --type coder
\`\`\`
`,
...
\`\`\`bash
npx hive-flow@alpha swarm init --topology adaptive
\`\`\`
...
\`\`\`javascript
mcp__hive-flow@alpha__swarm_init { topology: "mesh" }
mcp__hive-flow@alpha__agent_spawn { type: "researcher" }
\`\`\`
...
claude mcp add hive-flow@alpha npx hive-flow@alpha mcp start

echo "✅ MCP server setup complete!"
echo "🎯 You can now use mcp__hive-flow@alpha__ tools in Claude Code"
`,
...
echo "   npx hive-flow@alpha swarm init --topology hierarchical"
echo ""
echo "2. Spawn agents:"
echo "   npx hive-flow@alpha agent spawn --type coder --name \"API Developer\""
echo ""
echo "3. Orchestrate tasks:"
echo "   npx hive-flow@alpha task orchestrate --task \"Build REST API\""
echo ""
echo "4. Monitor progress:"
echo "   npx hive-flow@alpha swarm monitor"
echo ""
...
echo "  - npx hive-flow@alpha github swarm"
echo "  - npx hive-flow@alpha repo analyze"
echo "  - npx hive-flow@alpha pr enhance"
echo "  - npx hive-flow@alpha issue triage"
`,
...
/**
 * Hive Flow CLI - Universal Wrapper
...
(async () => {
  ...
  // Try multiple strategies to find hive-flow@alpha
  const strategies = [
    // 1. Local node_modules
    async () => {
      try {
        const localPath = resolve(process.cwd(), 'node_modules/.bin/hive-flow@alpha');
    ...
    async () => {
      try {
        const parentPath = resolve(process.cwd(), '../node_modules/.bin/hive-flow@alpha');
        const { existsSync } = await import('fs');
    ...
    async () => {
      return spawn('npx', ['hive-flow@alpha@2.0.0-alpha.25', ...process.argv.slice(2)], { stdio: 'inherit' });
    }
  ];
  ...
  console.error('Could not find hive-flow@alpha. Please install it with: npm install hive-flow@alpha');
  process.exit(1);
})();`;
  } else if (type === 'windows') {
    return `@echo off
rem Hive Flow wrapper script for Windows
...
if exist "%~dp0package.json" (
    ...
    if exist "%~dp0src\\cli\\simple-cli.js" (
        ...
        echo Error: Could not find Hive Flow CLI files
        exit /b 1
    )
) else (
    ...
    return `# Hive Flow wrapper script for PowerShell
...
if (Test-Path "$scriptPath\\package.json") {
    ...
    if (Test-Path "$scriptPath\\src\\cli\\simple-cli.js") {
        ...
        Write-Error "Could not find Hive Flow CLI files"
        exit 1
    }
} else {
    # Production mode - use npx alpha
    & npx hive-flow@alpha $args
}`;
  }
  return '';
}
...
function createEnhancedClaudeMdFallback() {
  ...
  try {
    ...
    return `# Claude Code Configuration for Hive Flow

## 🚀 IMPORTANT: Hive Flow AI-Driven Development
...
1. Add MCP server: \`claude mcp add hive-flow@alpha npx hive-flow@alpha mcp start\`
2. Initialize swarm: \`mcp__hive-flow@alpha__swarm_init { topology: "hierarchical" }\`
3. Spawn agents: \`mcp__hive-flow@alpha__agent_spawn { type: "coder" }\`
4. Orchestrate: \`mcp__hive-flow@alpha__task_orchestrate { task: "Build feature" }\`
  ...
  return JSON.stringify(
    {
      ...
      enabledMcpjsonServers: ['hive-flow@alpha', 'ruv-swarm'],
      hooks: {
        PreToolUse: [
          {
            matcher: 'Bash',
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.command // ""\' | xargs -I {} npx hive-flow@alpha hooks pre-command --command "{}" --validate-safety true --prepare-resources true',
              },
            ],
          },
          {
            ...
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.file_path // .tool_input.path // ""\' | xargs -I {} npx hive-flow@alpha hooks pre-edit --file "{}" --auto-assign-agents true --load-context true',
              },
              {
                type: 'command',
            ...
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.command // ""\' | xargs -I {} npx hive-flow@alpha hooks post-command --command "{}" --track-metrics true --store-results true',
              },
            ],
          },
          {
            ...
            hooks: [
              {
                type: 'command',
                command:
                  'cat | jq -r \'.tool_input.file_path // .tool_input.path // ""\' | xargs -I {} npx hive-flow@alpha hooks post-edit --file "{}" --format true --update-memory true --train-neural true',
              },
              {
                type: 'command',
            ...
            hooks: [
              {
                type: 'command',
                command:
                  '/usr/bin/env bash -c \'if command -v npx >/dev/null 2>&1; then npx hive-flow@alpha hooks session-end --generate-summary true --persist-state true --export-metrics true; else echo "⚠️  npx not available, skipping Hive Flow session-end hook"; fi\'',
              },
              {
                type: 'command',
