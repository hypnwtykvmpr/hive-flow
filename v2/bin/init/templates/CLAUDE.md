...
### Core SPARC Commands
- `npx hive-flow@alpha sparc modes`: List all available SPARC development modes
- `npx hive-flow@alpha sparc run <mode> "<task>"`: Execute specific SPARC mode for a task
- `npx hive-flow@alpha sparc tdd "<feature>"`: Run complete TDD workflow using SPARC methodology
- `npx hive-flow@alpha sparc info <mode>`: Get detailed information about a specific mode

### Batchtools Commands (Optimized)
- `npx hive-flow@alpha sparc batch <modes> "<task>"`: Execute multiple SPARC modes in parallel
- `npx hive-flow@alpha sparc pipeline "<task>"`: Execute full SPARC pipeline with parallel processing
- `npx hive-flow@alpha sparc concurrent <mode> "<tasks-file>"`: Process multiple tasks concurrently
...
npx hive-flow@alpha sparc run spec-pseudocode "Define user authentication requirements" --parallel
```
...
npx hive-flow@alpha sparc run spec-pseudocode "Create authentication flow pseudocode" --batch-optimize
```
...
npx hive-flow@alpha sparc run architect "Design authentication service architecture" --parallel
```
...
npx hive-flow@alpha sparc tdd "implement user authentication system" --batch-tdd
```
...
npx hive-flow@alpha sparc run integration "integrate authentication with user management" --parallel
```
...
### 🧠 Hive Flow MCP Tools ONLY Handle:
...
1. **MCP**: `mcp__hive-flow@alpha__swarm_init` (coordination setup)
2. **MCP**: `mcp__hive-flow@alpha__agent_spawn` (planning agents)
3. **MCP**: `mcp__hive-flow@alpha__task_orchestrate` (task coordination)
...
7. **MCP**: `mcp__hive-flow@alpha__memory_usage` (store results)

**❌ WRONG Workflow:**

1. **MCP**: `mcp__hive-flow@alpha__terminal_execute` (DON'T DO THIS)
...
[Single Message with BatchTool]:
  ...
  mcp__hive-flow@alpha__swarm_init { topology: "mesh", maxAgents: 6 }
  mcp__hive-flow@alpha__agent_spawn { type: "researcher" }
  mcp__hive-flow@alpha__agent_spawn { type: "coder" }
  mcp__hive-flow@alpha__agent_spawn { type: "code-analyzer" }
  mcp__hive-flow@alpha__agent_spawn { type: "tester" }
  mcp__hive-flow@alpha__agent_spawn { type: "task-orchestrator" }
...
```javascript
Message 1: mcp__hive-flow@alpha__swarm_init
...
```bash
# Add Hive Flow MCP server to Claude Code using stdio
claude mcp add hive-flow@alpha npx hive-flow@alpha mcp start
```

### 2. Use MCP Tools for Coordination in Claude Code

Once configured, Hive Flow MCP tools enhance Claude Code's coordination:

**Initialize a swarm:**

- Use the `mcp__hive-flow@alpha__swarm_init` tool to set up coordination topology
- Choose: mesh, hierarchical, ring, or star
- This creates a coordination framework for Claude Code's work

**Spawn agents:**

- Use `mcp__hive-flow@alpha__agent_spawn` tool to create specialized coordinators
- Agent types represent different thinking patterns, not actual coders
- They help Claude Code approach problems from different angles

**Orchestrate tasks:**

- Use `mcp__hive-flow@alpha__task_orchestrate` tool to coordinate complex workflows
...
- `mcp__hive-flow@alpha__swarm_init` - Set up coordination topology for Claude Code
- `mcp__hive-flow@alpha__agent_spawn` - Create cognitive patterns to guide Claude Code
- `mcp__hive-flow@alpha__task_orchestrate` - Break down and coordinate complex tasks

### Monitoring Tools:

- `mcp__hive-flow@alpha__swarm_status` - Monitor coordination effectiveness
- `mcp__hive-flow@alpha__agent_list` - View active cognitive patterns
- `mcp__hive-flow@alpha__agent_metrics` - Track coordination performance
- `mcp__hive-flow@alpha__task_status` - Check workflow progress
- `mcp__hive-flow@alpha__task_results` - Review coordination outcomes

### Memory & Neural Tools:

- `mcp__hive-flow@alpha__memory_usage` - Persistent memory across sessions
- `mcp__hive-flow@alpha__neural_status` - Neural pattern effectiveness
- `mcp__hive-flow@alpha__neural_train` - Improve coordination patterns
- `mcp__hive-flow@alpha__neural_patterns` - Analyze thinking approaches

### GitHub Integration Tools (NEW!):

- `mcp__hive-flow@alpha__github_swarm` - Create specialized GitHub management swarms
- `mcp__hive-flow@alpha__repo_analyze` - Deep repository analysis with AI
- `mcp__hive-flow@alpha__pr_enhance` - AI-powered pull request improvements
- `mcp__hive-flow@alpha__issue_triage` - Intelligent issue classification
- `mcp__hive-flow@alpha__code_review` - Automated code review with swarms

### System Tools:

- `mcp__hive-flow@alpha__benchmark_run` - Measure coordination efficiency
- `mcp__hive-flow@alpha__features_detect` - Available capabilities
- `mcp__hive-flow@alpha__swarm_monitor` - Real-time coordination tracking
...
- Tool: `mcp__hive-flow@alpha__swarm_init`
- Parameters: `{"topology": "mesh", "maxAgents": 5, "strategy": "balanced"}`
- Result: Creates a mesh topology for comprehensive exploration

**Step 2:** Define research perspectives

- Tool: `mcp__hive-flow@alpha__agent_spawn`
...
- Tool: `mcp__hive-flow@alpha__task_orchestrate`
...
2. Each agent MUST use Hive Flow hooks for coordination:
   - `npx hive-flow@alpha hooks pre-task` before starting
   - `npx hive-flow@alpha hooks post-edit` after each file operation
   - `npx hive-flow@alpha hooks notify` to share decisions
...
4. Agents share progress through Hive Flow memory
...
- Tool: `mcp__hive-flow@alpha__github_swarm`
...
When using Hive Flow coordination with Claude Code:
...
Hive Flow includes powerful hooks that automate coordination:
...
4. **ALL AGENTS MUST USE COORDINATION TOOLS** - Every spawned agent MUST use hive-flow@alpha hooks and memory

### 🎯 AGENT COUNT CONFIGURATION

**CRITICAL: Dynamic Agent Count Rules**

1. **Check CLI Arguments First**: If user runs `npx hive-flow@alpha --agents 5`, use 5 agents
...
```javascript
// If CLI args provided: npx hive-flow@alpha --agents 6
...
npx hive-flow@alpha hooks pre-task --description "[agent task]" --auto-spawn-agents false
npx hive-flow@alpha hooks session-restore --session-id "swarm-[id]" --load-memory true
```
...
npx hive-flow@alpha hooks post-edit --file "[filepath]" --memory-key "swarm/[agent]/[step]"

# Store decisions and findings
npx hive-flow@alpha hooks notify --message "[what was done]" --telemetry true

# Check coordination with other agents
npx hive-flow@alpha hooks pre-search --query "[what to check]" --cache-results true
```
...
npx hive-flow@alpha hooks session-end --export-metrics true --generate-summary true
```
...
1. START: Run `npx hive-flow@alpha hooks pre-task --description "[your task]"`
2. DURING: After EVERY file operation, run `npx hive-flow@alpha hooks post-edit --file "[file]" --memory-key "agent/[step]"`
3. MEMORY: Store ALL decisions using `npx hive-flow@alpha hooks notify --message "[decision]"`
4. END: Run `npx hive-flow@alpha hooks post-task --task-id "[task]" --analyze-performance true`
...
Message 1: [BatchTool]
  // MCP coordination setup
  - mcp__hive-flow@alpha__swarm_init
  - mcp__hive-flow@alpha__agent_spawn (researcher)
  - mcp__hive-flow@alpha__agent_spawn (coder)
  - mcp__hive-flow@alpha__agent_spawn (code-analyzer)
  - mcp__hive-flow@alpha__agent_spawn (tester)
  - mcp__hive-flow@alpha__agent_spawn (task-orchestrator)
...
[BatchTool]:
  ...
  - mcp__hive-flow@alpha__agent_spawn { type: "system-architect", name: "System Designer" }
  - mcp__hive-flow@alpha__agent_spawn { type: "coder", name: "API Developer" }
  - mcp__hive-flow@alpha__agent_spawn { type: "coder", name: "Frontend Dev" }
  - mcp__hive-flow@alpha__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  - mcp__hive-flow@alpha__agent_spawn { type: "tester", name: "QA Engineer" }
  - mcp__hive-flow@alpha__agent_spawn { type: "researcher", name: "Tech Lead" }
  - mcp__hive-flow@alpha__agent_spawn { type: "task-orchestrator", name: "PM" }
  - TodoWrite { todos: [multiple todos at once] }

STEP 2: PARALLEL TASK EXECUTION (Single Message!)
[BatchTool]:
  - mcp__hive-flow@alpha__task_orchestrate { task: "main task", strategy: "parallel" }
  - mcp__hive-flow@alpha__memory_usage { action: "store", key: "init", value: {...} }
...
[BatchTool - Message 1]:
  ...
  mcp__hive-flow@alpha__swarm_init { topology: "hierarchical", maxAgents: 8, strategy: "parallel" }
  mcp__hive-flow@alpha__agent_spawn { type: "system-architect", name: "System Designer" }
  mcp__hive-flow@alpha__agent_spawn { type: "coder", name: "API Developer" }
  mcp__hive-flow@alpha__agent_spawn { type: "coder", name: "Auth Expert" }
  mcp__hive-flow@alpha__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  mcp__hive-flow@alpha__agent_spawn { type: "tester", name: "Test Engineer" }
  mcp__hive-flow@alpha__agent_spawn { type: "task-orchestrator", name: "Lead" }
  ...
  // Start orchestration
  mcp__hive-flow@alpha__task_orchestrate { task: "Build REST API", strategy: "parallel" }

  // Store initial memory
  mcp__hive-flow@alpha__memory_usage { action: "store", key: "project/init", value: { started: Date.now() } }
...
Message 1: mcp__hive-flow@alpha__swarm_init
Message 2: mcp__hive-flow@alpha__agent_spawn (just one agent)
Message 3: mcp__hive-flow@alpha__agent_spawn (another agent)
Message 4: TodoWrite (single todo)
...
mcp__hive-flow@alpha__memory_usage
  action: "store"
...
4. **Monitor Progress**: Use mcp**hive-flow@alpha**swarm_monitor for real-time tracking
...
## Hive Flow v2.0.0 Features

Hive Flow extends the base coordination with:
...
- Documentation: https://github.com/ruvnet/hive-flow@alpha
- Issues: https://github.com/ruvnet/hive-flow@alpha/issues
- Examples: https://github.com/ruvnet/hive-flow@alpha/tree/main/examples

---

Remember: **Hive Flow coordinates, Claude Code creates!** Start with `mcp__hive-flow@alpha__swarm_init` to enhance your development workflow.
