...
export function showSparcCommandsHelp() {
  ...
  console.log();
  console.log('Usage:');
  console.log('  hive-flow sparc-<command> "<task-description>" [options]');
  console.log();
  console.log('Examples:');
  console.log('  hive-flow sparc-dev "build user authentication system"');
  console.log('  hive-flow sparc-api "create REST API for e-commerce" --swarm');
  console.log('  hive-flow sparc-test "comprehensive testing for payment module"');
  console.log('  hive-flow sparc-security "security audit for web application"');
}
