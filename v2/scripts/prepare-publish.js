...
const versionFiles = [
  ...
  { path: 'bin/hive-flow', pattern: /VERSION="[^"]+"/, replacement: `VERSION="${version}"` },
  ...
  { path: 'src/cli/simple-commands/process-ui-enhanced.js', pattern: /Hive-Flow Process Management UI v[0-9.]+/, replacement: `Hive-Flow Process Management UI v${version}` },
